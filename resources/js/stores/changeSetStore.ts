...
export const useChangeSetStore = defineStore('changeSet', () => {
    ...
    const createChangeSet = async (scenarioId: number, payload: any) => {
        ...
        try {
            const res = await fetch(
                `/api/strategic-planning/scenarios/${scenarioId}/change-sets`,
                {
                    method: 'POST',
    ...
    const previewChangeSet = async (id: number) => {
        ...
        try {
            const res = await fetch(
                `/api/strategic-planning/change-sets/${id}/preview`,
            );
    ...
    const applyChangeSet = async (id: number, payload?: any) => {
        ...
        try {
            ...
            const res = await fetch(
                `/api/strategic-planning/change-sets/${id}/apply`,
                opts,
            );
    ...
    const canApplyChangeSet = async (id: number) => {
        ...
        try {
            const res = await fetch(
                `/api/strategic-planning/change-sets/${id}/can-apply`,
            );
    ...
    const approveChangeSet = async (id: number) => {
        ...
        try {
            const res = await fetch(
                `/api/strategic-planning/change-sets/${id}/approve`,
                { method: 'POST' },
            );
    ...
    const rejectChangeSet = async (id: number) => {
        ...
        try {
            const res = await fetch(
                `/api/strategic-planning/change-sets/${id}/reject`,
                { method: 'POST' },
            );
