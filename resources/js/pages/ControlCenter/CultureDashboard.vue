<template>
    ...
    <div class="min-h-screen bg-[#0a0a0c] text-white">
        ...
        <div class="pa-6 mx-auto max-w-7xl">
            <!-- Header Section -->
            <div
            ...
            >
                <div>
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl border border-cyan-500/30 bg-cyan-500/10 text-cyan-400"
                        >
                        ...
                        >
                            {{
                                t('culture.dashboard.title') ||
                                'Stratos Identity Analytics'
                            }}
                        </h1>
                    </div>
                    <p class="mt-2 text-lg font-medium text-white/40">
                        {{
                            t('culture.dashboard.subtitle') ||
                            'Diagnóstico profundo de la salud y alineación cultural.'
                        }}
                    </p>
                </div>
                ...
                <div class="flex gap-4">
                    <v-btn
                        ...
                        :loading="scanning"
                        @click="runScan"
                        class="rounded-xl font-bold shadow-xl shadow-cyan-900/20"
                        style="color: white !important"
                    >
                        {{
                            t('culture.dashboard.run_scan') ||
                            'Ejecutar Escaneo'
                        }}
                    </v-btn>
                </div>
            ...
            <v-row>
                ...
                <v-col cols="12" md="4">
                    <v-card class="dashboard-card pa-6 h-full">
                        <div class="d-flex align-center mb-6 justify-between">
                            <div class="text-overline text-white/50">
                                CULTURAL HEALTH
                            </div>
                            <v-icon
                        ...
                        <div class="py-4 text-center">
                            <v-progress-circular
                                ...
                                :color="healthColor"
                            >
                                <div class="text-h2 font-black">
                                    {{ healthScore }}
                                </div>
                            </v-progress-circular>
                            <div
                                class="text-h6 mt-4 font-bold"
                ...
                <v-col cols="12" md="4">
                    <v-card class="dashboard-card pa-6 h-full">
                        ...
                        <div class="py-4 text-center">
                            ...
                            <div
                                class="text-h6 mt-4 font-bold"
                                :class="`text-${frictionColor}`"
                            >
                                {{ frictionLabel }}
                            </div>
                        </div>
                        <p
                            class="text-caption mt-2 px-4 text-center text-white/40"
                        >
                            Brecha entre la cultura declarada en el Blueprint y
                            la cultura vivida detectada.
                        </p>
                    </v-card>
                </v-col>
                ...
                <v-col cols="12" md="4">
                    <v-card class="dashboard-card pa-6 h-full">
                        <div class="d-flex align-center mb-4 justify-between">
                            <div class="text-overline text-white/50">
                                AI SENTINEL DIAGNOSIS
                            </div>
                            <v-chip size="x-small" color="cyan" variant="flat"
                                >LATEST INTELLIGENCE</v-chip
                            >
                        </div>
                        <div v-if="aiAnalysis" class="diagnosis-content">
                            <p
                                class="text-body-1 pa-4 mb-4 rounded-xl border border-cyan-500/10 bg-cyan-500/5 text-cyan-100/90 italic"
                            >
                                "{{ aiAnalysis.diagnosis }}"
                            </p>
                            <div class="mb-4">
                                <div
                                    class="text-caption mb-2 font-bold text-amber-300 uppercase"
                                >
                                    Acciones Críticas:
                                </div>
                                <div
                                    v-for="(
                                        action, i
                                    ) in aiAnalysis.ceo_actions"
                                    :key="i"
                                    class="d-flex text-body-2 mb-2 gap-2 text-white/70"
                                >
                                    <v-icon
                                        icon="mdi-flash"
                                        size="14"
                            ...
                            <div
                                class="pa-3 rounded-xl border border-red-500/20 bg-red-500/10"
                            >
                                <span
                                    class="text-caption font-bold text-red-300 uppercase"
                                    >Nodo Crítico:</span
                                >
                        ...
                        <div v-else class="py-10 text-center opacity-20">
                    ...
                    <v-card class="dashboard-card pa-6 h-full">
                        <div class="d-flex align-center mb-6 justify-between">
                            <div>
                                ...
                                <div class="text-h6 font-bold text-white">
                                    Radar de ADN Organizacional
                                </div>
                            </div>
                            <v-icon
                                icon="mdi-radar"
                        ...
                        <v-row class="mt-4 px-4 text-center">
                            <v-col cols="3">
                                <div
                                    class="text-caption font-bold text-indigo-300"
                                >
                                    CLAN
                                </div>
                                <div class="text-body-2 text-white/40">
                                    Colaborar
                                </div>
                            </v-col>
                            <v-col cols="3">
                                <div
                                    class="text-caption font-bold text-amber-300"
                                >
                                    ADHOCRACIA
                                </div>
                                <div class="text-body-2 text-white/40">
                            ...
                            <v-col cols="3">
                                <div
                                    class="text-caption font-bold text-red-300"
                                >
                                    MERCADO
                                </div>
                                <div class="text-body-2 text-white/40">
                            ...
                            <v-col cols="3">
                                <div
                                    class="text-caption font-bold text-green-300"
                                >
                                    JERARQUÍA
                                </div>
                                <div class="text-body-2 text-white/40">
                ...
                <v-col cols="12" md="5">
                    <v-card class="dashboard-card pa-6 h-full">
                        ...
                        <div
                            v-if="departmentSilos.length > 0"
                            class="silo-list"
                        >
                            <div
                                v-for="silo in departmentSilos"
                                :key="silo.name"
                                class="pa-4 d-flex align-center mb-3 justify-between rounded-2xl border border-white/5 bg-white/5"
                            >
                                <div>
                                    <div class="text-body-1 font-bold">
                                        {{ silo.name }}
                                    </div>
                                    <div class="text-caption text-white/40">
                                        Cultura Dominante: {{ silo.dominant }}
                                    </div>
                                </div>
                                <div class="text-right">
                                    <v-chip
                                        :color="
                                            silo.friction > 50 ? 'red' : 'amber'
                                        "
                                        size="small"
                                        variant="tonal"
                                    >
