...
const calculateRoi = async () => {
    ...
    try {
        const response: any = await api.post(
            '/api/strategic-planning/roi-calculator/calculate',
            form.value,
        );
        ...
        <v-row class="mb-4">
            <v-col cols="12">
                ...
                <p class="text-subtitle-1 text-medium-emphasis">
                    Compara estrategias de adquisición vs desarrollo de talentos
                    para asegurar la viabilidad del escenario.
                </p>
            </v-col>
        </v-row>
        ...
        <v-row>
            ...
            <v-col cols="12" md="4">
                <v-card class="pa-4 elevation-2">
                    <v-card-title class="px-0"
                        >Parámetros de Simulación</v-card-title
                    >
            ...
            <v-col cols="12" md="8">
                <div v-if="result">
                    ...
                    <v-row>
                        <v-col
                            v-for="(data, strategy) in result.roi_comparison"
                            :key="strategy"
                            cols="12"
                            lg="6"
                        >
                            <v-card class="h-100 rounded-lg border">
                                <v-toolbar
                                    density="compact"
                                    :color="getRoiColor(data.roi_index)"
                                    dark
                                >
                                    <v-toolbar-title
                                ...
                                <v-card-text>
                                    <v-list density="compact">
                                        ...
                                        <div
                                            class="pa-2 bg-grey-lighten-4 text-caption rounded italic"
                                        >
                ...
                <div
                    v-else
                    class="d-flex flex-column align-center text-medium-emphasis h-100 justify-center"
                >
                    <v-icon size="80" color="grey-lighten-2"
                        >mdi-calculator-outline</v-icon
                    >
                    <p>
                        Ingresa los parámetros y presiona "Calcular Impacto"
                        para ver la comparativa estratégica.
                    </p>
                </div>
            </v-col>
        </v-row>
