...
<template>
    <div
        class="people-profile-container relative min-h-screen bg-[#020617] p-8!"
    >
        ...
        >
            <div
                class="absolute -top-[10%] -left-[10%] h-[40%] w-[40%] rounded-full bg-current opacity-5 blur-[120px]"
            ></div>
            <div
                class="absolute right-[10%] -bottom-[10%] h-[35%] w-[35%] rounded-full bg-fuchsia-500/5 blur-[120px]"
            ></div>
        </div>
        ...
        <div
            ...
            class="relative z-10 mx-auto max-w-7xl animate-in duration-700 fade-in slide-in-from-bottom-4"
        >
            <!-- Navigation Back -->
            <div class="mb-6">
                <StButtonGlass
            ...
            <StCardGlass class="relative mb-8 overflow-hidden p-8!">
                ...
                <div class="flex flex-col items-center gap-8 md:flex-row">
                    ...
                    <div class="relative shrink-0">
                        <div
                            class="absolute inset-0 animate-pulse rounded-3xl bg-indigo-500/20 blur-xl"
                        ></div>
                        <div
                            class="relative h-32 w-32 overflow-hidden rounded-3xl border-2 border-white/20 shadow-2xl"
                        >
                            <img
                                :src="
                    ...
                    <div class="grow text-center md:text-left">
                        <div
                            class="mb-2 flex flex-wrap items-center justify-center gap-3 md:justify-start"
                        >
                            <h1
                                class="text-4xl font-black tracking-tight text-white md:text-5xl"
                            >
                                {{ personData.person.first_name }}
                                {{ personData.person.last_name }}
                            </h1>
                        ...
                        <div
                            class="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-white/50 md:justify-start"
                        >
                    ...
                    <!-- Match KPI Card -->
                    <div
                        class="flex flex-col items-center justify-center rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md"
                    >
                        <span
                ...
                <!-- Tabs Navigation -->
                <div
                    class="mt-10 flex flex-wrap justify-center gap-2 border-t border-white/5 pt-6 md:justify-start"
                >
                    <button
                        ...
                        :class="[
                            ...
                            activeTab === 'profile'
                                ? 'bg-indigo-500/20 text-indigo-300 shadow-[0_0_15px_rgba(99,102,241,0.2)] ring-1 ring-indigo-500/30'
            ...
            <!-- Tab Content -->
            <div class="animate-in duration-500 fade-in slide-in-from-top-4">
                <!-- Potential Tab -->
                <div
                ...
                >
                    <div class="lg:col-span-2">
                        <StCardGlass class="h-100 p-10!">
                            ...
                            >
                                <div
                                    class="mb-8 rounded-2xl border border-indigo-500/10 bg-indigo-500/5 p-6 backdrop-blur-md"
                                >
                                    <h4
                                        class="mb-2 text-xs font-black tracking-widest text-indigo-400 uppercase"
                                    >
                                        Síntesis Cerbero AI
                                    </h4>
                                    <p
                                ...
                                >
                                    <div
                                        ...
                                        :key="trait.id"
                                        class="group rounded-2xl border border-white/5 bg-white/2 p-5 transition-all hover:bg-white/5"
                                    >
                                        <div
                                        ...
                                        <div
                                            class="mb-3 h-2 w-full overflow-hidden rounded-full bg-white/5"
                                        >
                                            <div
                                        ...
                                        <p
                                            class="text-xs leading-relaxed text-white/40 italic"
                                        >
                                            "{{ trait.rationale }}"
                                        </p>
                                    </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div
                            v-if="
                                personData.person.metadata?.blind_spots?.length
                            "
                            class="rounded-3xl border border-rose-500/20 bg-linear-to-br from-rose-500/5 to-transparent p-8! backdrop-blur-xl"
                        >
                            <h4
                                class="mb-6 flex items-center gap-3 text-lg font-bold text-rose-300"
                            >
                            ...
                            <ul class="space-y-4">
                                <li
                                    ...
                                    :key="i"
                                    class="flex gap-3 text-sm leading-relaxed text-white/60"
                                >
                                    <PhWarningCircle
                                        :size="18"
                                        weight="fill"
                                        class="mt-0.5 shrink-0 text-rose-500/60"
                                    />
                                    {{ spot }}
                                </li>
                            </ul>
                        ...
                        <StCardGlass class="p-8!">
                            <h4 class="mb-6 text-lg font-bold text-white">
                                Red de Influencia 360
                            </h4>
                            <div class="space-y-4">
                                <div
                                    v-for="rel in personData.person.relations"
                                    :key="rel.id"
                                    class="group flex items-center gap-4 rounded-2xl border border-white/5 bg-white/2 p-3 transition-all hover:bg-white/5"
                                >
                                    <div
                                        class="h-10 w-10 overflow-hidden rounded-xl border border-white/10"
                                    >
                                        <img
                                            :src="
                                    ...
                                    <div class="grow">
                                        ...
                                        <div
                                            class="text-[10px] font-black tracking-widest text-indigo-400 uppercase opacity-60"
                                        >
                ...
                >
                    <div class="lg:col-span-3">
                        <StCardGlass class="p-10!">
                            <div class="mb-10 flex items-center gap-4">
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-2xl bg-fuchsia-500/10 text-fuchsia-400"
                                >
                            ...
                            <div
                                v-if="personData.competencies?.length"
                                class="space-y-12"
                            >
                                <div
                                ...
                                >
                                    <div
                                        class="mb-6 flex items-center justify-between border-b border-white/5 pb-2"
                                    >
                                        <h4
                                            class="text-lg font-bold text-indigo-300"
                                        >
                                            {{ comp.name }}
                                        </h4>
                                        <span
                                            class="text-[10px] font-black tracking-widest text-white/20 uppercase"
                                            >Core Competency</span
                                        >
                                    </div>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <span
                                                        class="text-sm font-bold text-white/80 group-hover:text-white"
                                                        >{{ skill.name }}</span
                                                    >
                                                </div>
                                                <div
                    ...
                    <div class="space-y-8 lg:col-span-2">
                        <div
                            class="flex flex-col items-center justify-center rounded-3xl border border-white/10 bg-white/5 p-10 text-center backdrop-blur-xl"
                        >
                            <h4
                                class="mb-4 text-xs font-black tracking-widest text-white/30 uppercase"
                            >
                                Eficiencia de Rol
                            </h4>
                            <div
                            ...
                            >
                                <svg class="h-32 w-32 -rotate-90">
                                    ...
                                    />
                                    <circle
                                        class="text-indigo-500 shadow-[0_0_15px_rgba(99,102,241,0.5)] transition-all duration-1000"
                                        stroke-width="10"
                                ...
                                <div
                                    class="absolute text-3xl font-black text-white"
                                >
                                    {{
                                        personData.gap_analysis
                                            ?.match_percentage || 0
                        ...
                        <div
                            class="rounded-3xl border border-indigo-500/20 bg-linear-to-br from-indigo-500/10 to-transparent p-8! backdrop-blur-xl"
                        >
                            <h4
                                class="mb-4 text-[10px] font-black tracking-widest text-indigo-400 uppercase"
                            >
                                Recomendación Estratégica
                            </h4>
                            <p
                                class="text-sm leading-relaxed text-white/70 italic"
                            >
                                "{{
                                    personData.gap_analysis?.match_percentage >
                                    85
                ...
                >
                    <StCardGlass class="p-10!">
                        ...
                        >
                            <div
                                ...
                                :key="scn.id"
                                class="rounded-2xl border border-fuchsia-500/20 bg-fuchsia-500/5 p-5"
                            >
                                <div
                                    class="mb-2 flex items-center justify-between"
                                >
                                    <div class="font-black text-fuchsia-300">
                                        {{ scn.name }}
                                    </div>
                        ...
                        >
                            ...
                            <p class="text-sm">
                                Sin participación en escenarios activos.
                            </p>
                        </div>
                    </StCardGlass>
                    ...
                    <StCardGlass class="p-10!">
                        <div class="mb-8 flex items-center gap-4">
                            <div
                                class="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-400"
                            >
                        ...
                        <div
                            class="flex flex-col items-center justify-center rounded-3xl border border-white/5 bg-white/2 py-20 text-center"
                        >
                            <PhShieldCheck
                                :size="64"
                                weight="thin"
                            ...
                            />
                            <div class="mb-2 text-lg font-bold text-white/60">
                                Estado de Respaldo
                            </div>
                            <p
                                class="max-w-xs text-sm font-light text-white/30"
                            >
                                Actualmente no está listado como sucesor
                                primario en posiciones críticas.
                            </p>
                            <StButtonGlass
                                variant="ghost"
                                size="sm"
                                class="mt-8 rounded-xl text-[10px] font-black tracking-widest uppercase"
                                >Vincular a Plan Estratégico</StButtonGlass
                            >
                        </div>
                    </StCardGlass>
                </div>
