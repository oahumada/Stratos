    ...
    >
        <v-card class="glass-card border-auth overflow-hidden" height="700">
            <v-row class="ma-0 h-100">
                ...
                >
                    <div class="mb-8">
                        <PhHeartbeat
                            ...
                            class="mb-2"
                        />
                        <h3 class="text-h5 font-weight-bold mb-1 text-white">
                ...
                >
                    <v-card-text class="pa-8 grow overflow-y-auto pb-0">
                        <!-- Step 1: Topics -->
                        <v-window v-model="step" class="h-100">
                            <v-window-item :value="1">
                                ...
                                <v-text-field
                                    ...
                                    :label="
                                        $t('px_command.wizard.step1.name_label')
                                    "
                                    :placeholder="
                                        $t(
                                ...
                                >
                                    {{
                                        $t('px_command.wizard.step1.dimensions')
                                    }}
                                </h3>
                                <v-row>
                                    <v-col
                            ...
                            <v-window-item :value="2">
                                ...
                                <v-alert
                                    v-if="
                                        newCampaign.mode === 'agent_autonomous'
                                    "
                                    type="info"
                                    variant="tonal"
                                ...
                                >
                                    ...
                                    />
                                    <strong>{{
                                        $t('px_command.wizard.step2.ai_enabled')
                                    }}</strong>
                                    {{ $t('px_command.wizard.step2.ai_desc') }}
                                </v-alert>
                            </v-window-item>
                            ...
                            <v-window-item :value="3">
                                ...
                                >
                                    ...
                                    <v-slider
                                        v-model="newCampaign.scope!.target_pct"
                                        min="5"
                                        max="100"
                                        step="5"
                                        color="success"
                            ...
                            <v-window-item :value="4">
                                ...
                                >
                                    <div class="d-flex pa-2 align-center">
                                        <PhRobot
                                            :size="24"
                                            class="text-success mr-3 shrink-0"
                                            weight="duotone"
                                        />
                                        <div>
                                            {{
