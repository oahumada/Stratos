...
import {
    LAYOUT_CONFIG,
    useScenarioLayout,
} from '@/composables/useScenarioLayout';
...
describe('ScenarioPlanning Component - Composables Integration', () => {
    ...
    describe('Layout calculations via useScenarioLayout', () => {
        ...
        it('wraps labels', () => {
            ...
            const long = layout.wrapLabel(
                'This is a very long capability name that needs wrapping',
                10,
            );
    ...
    describe('Integrated workflow: Capability → Competencies → Skills', () => {
        ...
        it('expands competency to show skills', () => {
            ...
            state.grandChildEdges.value = state.grandChildNodes.value.map(
                (gc) => ({
        ...
        it('sets up edge rendering for complete hierarchy', () => {
            ...
            state.grandChildEdges.value = [{ source: 10, target: 100 }];
    ...
    describe('Composable coordination', () => {
        ...
        it('state updates trigger edge recalculations', () => {
            ...
            // Update state
            state.nodes.value = [
                { id: 1, type: 'capability', name: 'Test', x: 100, y: 100 },
            ];
            state.childNodes.value = [
                { id: 10, type: 'competency', name: 'Child', x: 200, y: 100 },
            ];
            state.childEdges.value = [{ source: 1, target: 10 }];
