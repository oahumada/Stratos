...
const insights = computed(() => [
    {
        ...
        description:
            'Current retry rate is 18%, consider implementing exponential backoff',
        severity: 'info',
        action: 'View Details',
    },
    {
        ...
        description:
            'Error rate increased by 5% in the last 2 hours. Investigate metrics history.',
        severity: 'warning',
        action: 'Investigate',
    },
    {
        ...
        description:
            'Based on confidence trend, system should transition to next phase tonight',
        severity: 'info',
        action: 'Prepare',
    },
    {
        ...
        description:
            'Increase sample size by 15% to improve confidence score reliability',
        severity: 'info',
        action: 'Configure',
    },
]);
    ...
    >
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-white/50">
                ML-driven analysis & predictive alerts
            </p>
        </div>
        ...
        <div class="mb-8 space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div
                    ...
                    :key="insight.id"
                    class="rounded-lg border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition hover:bg-white/10"
                >
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <button
                                class="mt-3 inline-block rounded-lg bg-blue-500/20 px-3 py-1 text-xs font-medium text-blue-300 transition hover:bg-blue-500/30"
                            >
                                {{ insight.action }} →
                            </button>
                        </div>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div v-if="recommendations.length > 0" class="space-y-3">
                    ...
                    >
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            ...
                            <button
                                class="ml-auto text-xs text-white/70 hover:text-white"
                            >
                                Learn more →
                            </button>
                        </div>
            ...
            <div
                class="flex flex-col rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl"
            >
                ...
                >
                    <!-- Score Circle -->
                    <div
                        class="relative flex h-32 w-32 items-center justify-center rounded-full border-4 border-white/10 bg-gradient-to-br from-green-500/20 to-blue-500/20"
                    >
                    ...
                    <div class="text-center">
                        <p
                            class="inline-block rounded-lg bg-green-500/20 px-3 py-1 text-sm font-medium text-green-300"
                        >
                            ✓ Excellent
                        </p>
            ...
            <div class="space-y-4">
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <div class="h-12 w-0.5 bg-white/10"></div>
                    </div>
                    <div class="pb-8">
                        <p class="font-semibold text-white">Error Rate Spike</p>
                        <p class="text-sm text-white/70">
                            +5% increase detected at 14:32
                        </p>
                        <p class="mt-2 text-xs text-white/50">
                            Severity: Medium • Duration: 23 min
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="pb-8">
                        ...
                        <p class="text-sm text-white/70">
                            Score increased to 90% at 11:15
                        </p>
                        <p class="mt-2 text-xs text-white/50">
                            Cause: Increased sample size
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white/70">
                            All metrics within normal range at 08:00
                        </p>
                        <p class="mt-2 text-xs text-white/50">
        ...
        >
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div
                    class="space-y-2 rounded-lg border border-white/10 bg-white/5 p-4"
                >
