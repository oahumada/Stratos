...
<template>
    ...
    >
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-white/50">
                    Live event stream & system activity
                </p>
            </div>
            <div class="flex items-center gap-2">
                ...
                <label
                    class="ml-4 flex items-center gap-2 text-sm text-white/70"
                >
                    <input
                        v-model="autoScroll"
                        type="checkbox"
        ...
        <div class="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-5">
            <div
                class="rounded-xl border border-white/10 bg-white/5 p-4 text-center backdrop-blur-xl"
            >
        ...
        <!-- Event Stream -->
        <div
            class="overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl"
        >
            <!-- Header -->
            ...
            <!-- Events List -->
            <div
                class="max-h-[calc(100vh-400px)] space-y-2 overflow-y-auto p-6"
            >
                <div
                    v-if="realtimeEvents.length === 0"
        ...
        <div
            v-if="metrics"
            class="mt-6 rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl"
        >
