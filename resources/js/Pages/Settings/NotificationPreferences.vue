<template>
    <div class="notification-preferences">
        <v-card>
            ...
            <v-card-text>
                <v-alert v-if="loading" type="info" title="Loading...">
                ...
                <div v-else>
                    ...
                    >
                        <p class="text-subtitle-2 text-disabled">
                            No channels configured. Add one below to start
                        ...
                        >
                            ...
                            <template #append>
                                <v-switch
                                    ...
                                    :loading="
                                        togglingChannel === pref.channel_type
                                    "
                                ...
                                <v-btn
                                    ...
                                    variant="text"
                                    :loading="
                                        deletingChannel === pref.channel_type
                                    "
...
async function fetchPreferences() {
    try {
        ...
        availableChannels.value = response.data.available_channels.map(
            (ch: string) => ({
