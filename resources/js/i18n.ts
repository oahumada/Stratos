export const messages = {
    en: {
        ...
        role_wizard: {
            ...
            capacity_blueprint: 'Competency Matrix',
            capacity_desc:
                'Define the core strategic assets required for this architectural node.',
            strategic_capacity: 'Strategic Competency',
            mastery_req: 'Mastery Req.',
            ai_rationale: 'AI Rationale',
            view_skill_blueprint: 'View Skill Blueprint',
            review_bars: 'Review BARS',
            bars_definition: 'BARS Definition',
            bars_desc: 'Behavior, Attitude, Responsibility, Skill standards.',
            bars_behavior: 'Behavior (Conduct)',
            bars_attitude: 'Attitude (Mindset)',
            bars_responsibility: 'Responsibility',
            bars_skill: 'Specialized Skill',
            competencies_aligned: 'Aligned Competencies',
            competency_index: 'Competency Index',
            learning_units: 'Learning Units (Knowledge)',
            ...
            generate_bars: 'Generate BARS Model & Proposal',
            save_draft: 'Save Progress',
            save_and_approve: 'Save & Request Approval',
        },
        px_command: {
            title: 'Strategy',
    ...
    es: {
        ...
        role_wizard: {
            ...
            step1_title: 'Definición de Objetivos',
            step1_desc: 'Nombre y Misión',
            step2_title: 'Mapeo de Cubo',
            step2_desc: 'Coords Estructurales',
            step3_title: 'Impacto',
            step3_desc: 'Propósito y Resultados',
            ...
            capacity_blueprint: 'Matriz de Competencias',
            capacity_desc:
                'Define los activos estratégicos clave requeridos para este nodo arquitectónico.',
            strategic_capacity: 'Competencia Estratégica',
            ...
            bars_skill: 'Skill (Habilidad)',
            competencies_aligned: 'Competencias Alineadas',
            competency_index: 'Índice de Competencias',
            learning_units: 'Unidades de Aprendizaje',
            performance_criteria: 'Criterios de Desempeño',
            ...
            generate_bars: 'Generar Modelo BARS & Propuesta',
            save_draft: 'Guardar',
            save_and_approve: 'Guardar y Solicitar Aprobación',
        },
        px_command: {
            title: 'Estrategia',
            title_highlight: 'People Experience',
        ...
        roles_module: {
            ...
            skills_section: {
                ...
                empty: 'No hay competencias asignadas',
        ...
        bulk_import: {
            steps: {
                ...
                resolution: 'Resolución de Gaps',
                approval: 'Sellado y Sinc',
            },
        },
    },
};
