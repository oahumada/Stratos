...
getApprovalDetails.url = (
    ...
    return (
        getApprovalDetails.definition.url
 ...
 */
export const generateSkillBlueprint = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/roles/generate-skill-blueprint'
 */
const generateSkillBlueprintForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/roles/generate-skill-blueprint'
 */
generateSkillBlueprintForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: generateSkillBlueprint.url(options),
    method: 'post',
 ...
 */
export const materializeCompetencies = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
...
materializeCompetencies.url = (
    ...
    return (
        materializeCompetencies.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/strategic-planning/roles/{id}/materialize-competencies'
 */
const materializeCompetenciesForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/roles/{id}/materialize-competencies'
 */
materializeCompetenciesForm.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: materializeCompetencies.url(args, options),
...
requestApproval.url = (
    ...
    return (
        requestApproval.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const requestCompetencyApproval = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
...
requestCompetencyApproval.url = (
    ...
    return (
        requestCompetencyApproval.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/strategic-planning/competencies/{id}/request-approval'
 */
requestCompetencyApproval.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: requestCompetencyApproval.url(args, options),
 ...
 * @route '/api/strategic-planning/competencies/{id}/request-approval'
 */
const requestCompetencyApprovalForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/competencies/{id}/request-approval'
 */
requestCompetencyApprovalForm.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: requestCompetencyApproval.url(args, options),
 ...
 */
const showApprovalRequest254d24a1d75ba575129d55878c80dc74 = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/role/{token}'
 */
showApprovalRequest254d24a1d75ba575129d55878c80dc74.url = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
    ...
    return (
        showApprovalRequest254d24a1d75ba575129d55878c80dc74.definition.url
            .replace('{token}', parsedArgs.token.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/approve/role/{token}'
 */
showApprovalRequest254d24a1d75ba575129d55878c80dc74.get = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/role/{token}'
 */
showApprovalRequest254d24a1d75ba575129d55878c80dc74.head = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/role/{token}'
 */
const showApprovalRequest254d24a1d75ba575129d55878c80dc74Form = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
    ...
    action: showApprovalRequest254d24a1d75ba575129d55878c80dc74.url(
        args,
        options,
    ),
    method: 'get',
 ...
 * @route '/approve/role/{token}'
 */
showApprovalRequest254d24a1d75ba575129d55878c80dc74Form.get = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/role/{token}'
 */
showApprovalRequest254d24a1d75ba575129d55878c80dc74Form.head = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
...
showApprovalRequest254d24a1d75ba575129d55878c80dc74.form =
    showApprovalRequest254d24a1d75ba575129d55878c80dc74Form;
/**
 * @see \App\Http\Controllers\Api\RoleDesignerController::showApprovalRequest
 * @see app/Http/Controllers/Api/RoleDesignerController.php:88
 * @route '/approve/competency/{token}'
 */
const showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4 = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/competency/{token}'
 */
showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4.url = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
    ...
    return (
        showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4.definition.url
            .replace('{token}', parsedArgs.token.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/approve/competency/{token}'
 */
showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4.get = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/competency/{token}'
 */
showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4.head = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/competency/{token}'
 */
const showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4Form = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
    ...
    action: showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4.url(
        args,
        options,
    ),
    method: 'get',
 ...
 * @route '/approve/competency/{token}'
 */
showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4Form.get = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
 ...
 * @route '/approve/competency/{token}'
 */
showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4Form.head = (
    args:
        | { token: string | number }
        | [token: string | number]
        | string
...
showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4.form =
    showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4Form;

export const showApprovalRequest = {
    '/approve/role/{token}':
        showApprovalRequest254d24a1d75ba575129d55878c80dc74,
    '/approve/competency/{token}':
        showApprovalRequestaf6ddcd1ab18a4bf817880b5d807cdf4,
};

const RoleDesignerController = {
    getApprovalDetails,
    approve,
    analyzePreview,
