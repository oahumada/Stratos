...
* @see app/Http/Controllers/Api/CompetencyCuratorController.php:21
...
* @see app/Http/Controllers/Api/CompetencyCuratorController.php:35
...
const CompetencyCuratorController = { curate, generateQuestions }
