...
generateQuestions.url = (
    ...
    return (
        generateQuestions.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
curateCompetency.url = (
    ...
    return (
        curateCompetency.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
const CompetencyCuratorController = {
    curate,
    generateQuestions,
    curateCompetency,
};
