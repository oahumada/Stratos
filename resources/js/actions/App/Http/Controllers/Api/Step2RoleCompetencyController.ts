...
export const deleteMapping = (
    args:
        | { id: string | number; mappingId: string | number }
        | [id: string | number, mappingId: string | number],
    options?: RouteQueryOptions,
...
getRoleForecasts.url = (
    ...
    return (
        getRoleForecasts.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const getSkillGapsMatrix = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
getSkillGapsMatrix.url = (
    ...
    return (
        getSkillGapsMatrix.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const getMatchingResults = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
getMatchingResults.url = (
    ...
    return (
        getMatchingResults.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const getSuccessionPlans = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
getSuccessionPlans.url = (
    ...
    return (
        getSuccessionPlans.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const orchestrateCapabilities = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
...
orchestrateCapabilities.url = (
    ...
    return (
        orchestrateCapabilities.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/scenarios/{id}/step2/orchestrate-capabilities'
 */
const orchestrateCapabilitiesForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/scenarios/{id}/step2/orchestrate-capabilities'
 */
orchestrateCapabilitiesForm.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: orchestrateCapabilities.url(args, options),
...
const Step2RoleCompetencyController = {
    getMatrixData,
    saveMapping,
    deleteMapping,
    addRole,
