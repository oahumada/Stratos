 ...
 */
export const verifyRoleCredentialPublic = (
 ...
 * @route '/api/compliance/public/credentials/verify'
 */
verifyRoleCredentialPublic.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: verifyRoleCredentialPublic.url(options),
    method: 'post',
 ...
 * @route '/api/compliance/public/credentials/verify'
 */
const verifyRoleCredentialPublicForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/api/compliance/public/credentials/verify'
 */
verifyRoleCredentialPublicForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: verifyRoleCredentialPublic.url(options),
    method: 'post',
 ...
 */
export const exportRoleCredential = (
    args:
...
exportRoleCredential.url = (
    ...
    return (
        exportRoleCredential.definition.url
 ...
 * @route '/api/compliance/credentials/roles/{roleId}'
 */
const exportRoleCredentialForm = (
    args:
        | { roleId: string | number }
        | [roleId: string | number]
        | string
 ...
 */
export const verifyRoleCredential = (
    args:
        | { roleId: string | number }
        | [roleId: string | number]
        | string
...
verifyRoleCredential.url = (
    ...
    return (
        verifyRoleCredential.definition.url
            .replace('{roleId}', parsedArgs.roleId.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/compliance/credentials/roles/{roleId}/verify'
 */
const verifyRoleCredentialForm = (
    args:
        | { roleId: string | number }
        | [roleId: string | number]
        | string
 ...
 */
export const internalAuditWizard = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
const ComplianceAuditController = {
    verifyRoleCredentialPublic,
    verifierMetadata,
    index,
    summary,
    iso30414Summary,
