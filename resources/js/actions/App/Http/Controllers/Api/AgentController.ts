 ...
 * @see app/Http/Controllers/Api/AgentController.php:65
 * @route '/api/agents/{agent}'
 */
export const update = (
    args:
        | { agent: number | { id: number } }
        | [agent: number | { id: number }]
        | number
        | { id: number },
    options?: RouteQueryOptions,
...
update.url = (
    ...
    const parsedArgs = {
        agent: typeof args.agent === 'object' ? args.agent.id : args.agent,
    };
 ...
 * @see app/Http/Controllers/Api/AgentController.php:46
