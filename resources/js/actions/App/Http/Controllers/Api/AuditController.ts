...
export const entityTimeline = (
    args:
        | { entityType: string | number; entityId: string | number }
        | [entityType: string | number, entityId: string | number],
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
