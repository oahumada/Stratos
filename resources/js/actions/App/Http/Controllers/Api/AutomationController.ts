...
export const triggerWorkflow = (
    args: { code: string | number } | [code: string | number] | string | number,
    options?: RouteQueryOptions,
...
triggerWorkflow.url = (
    ...
    return (
        triggerWorkflow.definition.url
 ...
 */
export const listAvailableWorkflows = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/api/automation/workflows/available'
 */
const listAvailableWorkflowsForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/automation/workflows/available'
 */
listAvailableWorkflowsForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: listAvailableWorkflows.url(options),
    method: 'get',
 ...
 * @route '/api/automation/workflows/available'
 */
listAvailableWorkflowsForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
...
getExecutionStatus.url = (
    ...
    return (
        getExecutionStatus.definition.url
...
cancelExecution.url = (
    ...
    return (
        cancelExecution.definition.url
            .replace('{executionId}', parsedArgs.executionId.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
getWebhookStats.url = (
    ...
    return (
        getWebhookStats.definition.url
            .replace('{webhookId}', parsedArgs.webhookId.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/automation/remediation-history'
 */
const getRemediationHistoryForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/automation/remediation-history'
 */
getRemediationHistoryForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/automation/status'
 */
export const toggleAutomationStatus = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/automation/status'
 */
const toggleAutomationStatusForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/automation/status'
 */
toggleAutomationStatusForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: toggleAutomationStatus.url(options),
    method: 'post',
