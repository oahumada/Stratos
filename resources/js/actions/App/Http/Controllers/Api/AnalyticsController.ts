 ...
 */
export const forecastCompliance = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 */
export const predictDeploymentWindow = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/api/analytics/predictions/deployment-window'
 */
const predictDeploymentWindowForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/analytics/predictions/deployment-window'
 */
predictDeploymentWindowForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: predictDeploymentWindow.url(options),
    method: 'get',
 ...
 * @route '/api/analytics/predictions/deployment-window'
 */
predictDeploymentWindowForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/analytics/predictions/resources'
 */
const predictResourceNeedsForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 */
export const assessTransitionRisk = (
    options?: RouteQueryOptions,
 ...
 * @route '/api/analytics/predictions/transition-risk'
 */
const assessTransitionRiskForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/api/analytics/metrics/comparison'
 */
const getMetricsComparisonForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/analytics/metrics/latency-percentiles'
 */
const getLatencyPercentilesForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/analytics/metrics/latency-percentiles'
 */
getLatencyPercentilesForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
