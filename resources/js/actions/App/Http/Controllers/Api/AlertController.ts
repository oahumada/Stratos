...
* @see app/Http/Controllers/Api/AlertController.php:21
...
* @see app/Http/Controllers/Api/AlertController.php:37
* @route '/api/alerts/thresholds'
*/
...
*/
export const showThreshold = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/alerts/thresholds/{threshold}'
*/
showThreshold.url = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
...
* @route '/api/alerts/thresholds/{threshold}'
*/
showThreshold.get = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showThreshold.url(args, options),
    method: 'get',
})
...
* @route '/api/alerts/thresholds/{threshold}'
*/
showThreshold.head = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: showThreshold.url(args, options),
    method: 'head',
})
...
* @route '/api/alerts/thresholds/{threshold}'
*/
const showThresholdForm = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/alerts/thresholds/{threshold}'
*/
showThresholdForm.get = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: showThreshold.url(args, options),
    method: 'get',
})
...
* @route '/api/alerts/thresholds/{threshold}'
*/
showThresholdForm.head = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @see app/Http/Controllers/Api/AlertController.php:67
* @route '/api/alerts/thresholds/{threshold}'
*/
export const updateThreshold = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/api/alerts/thresholds/{threshold}'
*/
updateThreshold.url = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { threshold: args }
    }
...
* @route '/api/alerts/thresholds/{threshold}'
*/
updateThreshold.patch = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateThreshold.url(args, options),
    method: 'patch',
})
...
* @route '/api/alerts/thresholds/{threshold}'
*/
const updateThresholdForm = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/alerts/thresholds/{threshold}'
*/
updateThresholdForm.patch = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateThreshold.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @see app/Http/Controllers/Api/AlertController.php:85
* @route '/api/alerts/thresholds/{threshold}'
*/
export const destroyThreshold = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/api/alerts/thresholds/{threshold}'
*/
destroyThreshold.url = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { threshold: args }
    }
...
* @route '/api/alerts/thresholds/{threshold}'
*/
destroyThreshold.delete = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyThreshold.url(args, options),
    method: 'delete',
})
...
* @route '/api/alerts/thresholds/{threshold}'
*/
const destroyThresholdForm = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/alerts/thresholds/{threshold}'
*/
destroyThresholdForm.delete = (args: { threshold: number | { id: number } } | [threshold: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: destroyThreshold.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
*/
export const showHistory = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/alerts/history/{alert}'
*/
showHistory.url = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { alert: args }
    }
...
* @route '/api/alerts/history/{alert}'
*/
showHistory.get = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showHistory.url(args, options),
    method: 'get',
})
...
* @route '/api/alerts/history/{alert}'
*/
showHistory.head = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: showHistory.url(args, options),
    method: 'head',
})
...
* @route '/api/alerts/history/{alert}'
*/
const showHistoryForm = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/alerts/history/{alert}'
*/
showHistoryForm.get = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: showHistory.url(args, options),
    method: 'get',
})
...
* @route '/api/alerts/history/{alert}'
*/
showHistoryForm.head = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @see app/Http/Controllers/Api/AlertController.php:130
* @route '/api/alerts/history/{alert}/acknowledge'
*/
export const acknowledgeAlert = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/alerts/history/{alert}/acknowledge'
*/
acknowledgeAlert.url = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { alert: args }
    }
...
* @route '/api/alerts/history/{alert}/acknowledge'
*/
acknowledgeAlert.post = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: acknowledgeAlert.url(args, options),
    method: 'post',
})
...
* @route '/api/alerts/history/{alert}/acknowledge'
*/
const acknowledgeAlertForm = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/alerts/history/{alert}/acknowledge'
*/
acknowledgeAlertForm.post = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: acknowledgeAlert.url(args, options),
    method: 'post',
})
...
* @see app/Http/Controllers/Api/AlertController.php:150
* @route '/api/alerts/history/{alert}/resolve'
*/
export const resolveAlert = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/alerts/history/{alert}/resolve'
*/
resolveAlert.url = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { alert: args }
    }
...
* @route '/api/alerts/history/{alert}/resolve'
*/
resolveAlert.post = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resolveAlert.url(args, options),
    method: 'post',
})
...
* @route '/api/alerts/history/{alert}/resolve'
*/
const resolveAlertForm = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/alerts/history/{alert}/resolve'
*/
resolveAlertForm.post = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: resolveAlert.url(args, options),
    method: 'post',
})
...
* @see app/Http/Controllers/Api/AlertController.php:166
* @route '/api/alerts/history/{alert}/mute'
*/
export const muteAlert = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/alerts/history/{alert}/mute'
*/
muteAlert.url = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { alert: args }
    }
...
* @route '/api/alerts/history/{alert}/mute'
*/
muteAlert.post = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: muteAlert.url(args, options),
    method: 'post',
})
...
* @route '/api/alerts/history/{alert}/mute'
*/
const muteAlertForm = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/alerts/history/{alert}/mute'
*/
muteAlertForm.post = (args: { alert: number | { id: number } } | [alert: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: muteAlert.url(args, options),
    method: 'post',
})
...
* @see app/Http/Controllers/Api/AlertController.php:182
...
* @see app/Http/Controllers/Api/AlertController.php:194
...
* @see app/Http/Controllers/Api/AlertController.php:206
...
* @see app/Http/Controllers/Api/AlertController.php:230
...
* @see app/Http/Controllers/Api/AlertController.php:258
