 ...
 */
export const analyzeHeadcountImpact = (
 ...
 * @route '/api/strategic-planning/what-if/headcount-impact'
 */
const analyzeHeadcountImpactForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/api/strategic-planning/what-if/headcount-impact'
 */
analyzeHeadcountImpactForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: analyzeHeadcountImpact.url(options),
    method: 'post',
 ...
 */
export const analyzeFinancialImpact = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/what-if/financial-impact'
 */
const analyzeFinancialImpactForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/what-if/financial-impact'
 */
analyzeFinancialImpactForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: analyzeFinancialImpact.url(options),
    method: 'post',
 ...
 */
export const analyzeRiskImpact = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/what-if/sensitivity-analysis'
 */
performSensitivityAnalysis.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: performSensitivityAnalysis.url(options),
    method: 'post',
 ...
 * @route '/api/strategic-planning/what-if/sensitivity-analysis'
 */
const performSensitivityAnalysisForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/what-if/sensitivity-analysis'
 */
performSensitivityAnalysisForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: performSensitivityAnalysis.url(options),
    method: 'post',
 ...
 * @route '/api/strategic-planning/what-if/comprehensive'
 */
comprehensiveAnalysisForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: comprehensiveAnalysis.url(options),
    method: 'post',
...
const WhatIfAnalysisController = {
    analyzeHeadcountImpact,
