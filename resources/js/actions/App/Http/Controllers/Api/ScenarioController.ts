 ...
 */
export const getCapabilityTree = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
getCapabilityTree.url = (
    ...
    return (
        getCapabilityTree.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
exportFinancial.url = (
    ...
    return (
        exportFinancial.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
instantiateFromTemplate.url = (
    ...
    return (
        instantiateFromTemplate.definition.url
 ...
 * @route '/api/strategic-planning/scenarios/{template_id}/instantiate-from-template'
 */
const instantiateFromTemplateForm = (
    args:
        | { template_id: string | number }
        | [template_id: string | number]
        | string
 ...
 * @route '/api/strategic-planning/scenarios/{template_id}/instantiate-from-template'
 */
instantiateFromTemplateForm.post = (
    args:
        | { template_id: string | number }
        | [template_id: string | number]
        | string
 ...
 */
export const refreshSuggestedStrategies = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/scenarios/{id}/refresh-suggested-strategies'
 */
refreshSuggestedStrategies.url = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return (
        refreshSuggestedStrategies.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/strategic-planning/scenarios/{id}/refresh-suggested-strategies'
 */
refreshSuggestedStrategies.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: refreshSuggestedStrategies.url(args, options),
 ...
 * @route '/api/strategic-planning/scenarios/{id}/refresh-suggested-strategies'
 */
const refreshSuggestedStrategiesForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/scenarios/{id}/refresh-suggested-strategies'
 */
refreshSuggestedStrategiesForm.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: refreshSuggestedStrategies.url(args, options),
...
finalizeScenario.url = (
    ...
    return (
        finalizeScenario.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
compareVersions.url = (
    ...
    return (
        compareVersions.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
destroyScenario.url = (
    ...
    return (
        destroyScenario.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
const designTalent14e3fa9c27a9681e666c0a5b14d6ff59 = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/scenarios/{id}/orchestrate'
 */
designTalent14e3fa9c27a9681e666c0a5b14d6ff59.url = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return (
        designTalent14e3fa9c27a9681e666c0a5b14d6ff59.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/strategic-planning/scenarios/{id}/orchestrate'
 */
designTalent14e3fa9c27a9681e666c0a5b14d6ff59.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: designTalent14e3fa9c27a9681e666c0a5b14d6ff59.url(args, options),
 ...
 * @route '/api/strategic-planning/scenarios/{id}/orchestrate'
 */
const designTalent14e3fa9c27a9681e666c0a5b14d6ff59Form = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/strategic-planning/scenarios/{id}/orchestrate'
 */
designTalent14e3fa9c27a9681e666c0a5b14d6ff59Form.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: designTalent14e3fa9c27a9681e666c0a5b14d6ff59.url(args, options),
...
designTalent14e3fa9c27a9681e666c0a5b14d6ff59.form =
    designTalent14e3fa9c27a9681e666c0a5b14d6ff59Form;
/**
 * @see \App\Http\Controllers\Api\ScenarioController::designTalent
 * @see app/Http/Controllers/Api/ScenarioController.php:610
 * @route '/api/scenarios/{id}/step2/design-talent'
 */
const designTalent65fe0a91261300d85c30e48fcfd18cb6 = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/api/scenarios/{id}/step2/design-talent'
 */
designTalent65fe0a91261300d85c30e48fcfd18cb6.url = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return (
        designTalent65fe0a91261300d85c30e48fcfd18cb6.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/scenarios/{id}/step2/design-talent'
 */
designTalent65fe0a91261300d85c30e48fcfd18cb6.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: designTalent65fe0a91261300d85c30e48fcfd18cb6.url(args, options),
 ...
 * @route '/api/scenarios/{id}/step2/design-talent'
 */
const designTalent65fe0a91261300d85c30e48fcfd18cb6Form = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/scenarios/{id}/step2/design-talent'
 */
designTalent65fe0a91261300d85c30e48fcfd18cb6Form.post = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: designTalent65fe0a91261300d85c30e48fcfd18cb6.url(args, options),
...
designTalent65fe0a91261300d85c30e48fcfd18cb6.form =
    designTalent65fe0a91261300d85c30e48fcfd18cb6Form;

export const designTalent = {
    '/api/strategic-planning/scenarios/{id}/orchestrate':
        designTalent14e3fa9c27a9681e666c0a5b14d6ff59,
    '/api/scenarios/{id}/step2/design-talent':
        designTalent65fe0a91261300d85c30e48fcfd18cb6,
};
...
getIncubatedTree.url = (
    ...
    return (
        getIncubatedTree.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 */
export const applyAgentProposals = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
...
applyAgentProposals.url = (
    ...
    return (
        applyAgentProposals.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
getCompetencyGaps.url = (
    ...
    return (
        getCompetencyGaps.definition.url
            .replace('{id}', parsedArgs.id.toString())
...
deriveAllSkills.url = (
    ...
    return (
        deriveAllSkills.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
