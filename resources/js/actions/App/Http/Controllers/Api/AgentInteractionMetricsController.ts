...
const AgentInteractionMetricsController = {
    summary,
    failingAgents,
    latencyByAgent,
};

export default AgentInteractionMetricsController;
