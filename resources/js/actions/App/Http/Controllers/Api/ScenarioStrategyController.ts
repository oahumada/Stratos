 ...
 */
export const getGapsForAssignment = (
...
getGapsForAssignment.url = (
    ...
    return (
        getGapsForAssignment.definition.url
 ...
 * @route '/api/strategic-planning/scenarios/{id}/gaps-for-assignment'
 */
const getGapsForAssignmentForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
 ...
 */
export const getStrategyPortfolio = (
    args:
...
getStrategyPortfolio.url = (
    ...
    return (
        getStrategyPortfolio.definition.url
 ...
 * @route '/api/strategic-planning/strategies/portfolio/{scenario_id}'
 */
const getStrategyPortfolioForm = (
    args:
        | { scenario_id: string | number }
        | [scenario_id: string | number]
        | string
 ...
 */
export const getStrategiesByScenario = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
getStrategiesByScenario.url = (
    ...
    return (
        getStrategiesByScenario.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/strategic-planning/scenarios/{id}/strategies'
 */
const getStrategiesByScenarioForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/strategic-planning/scenarios/{id}/strategies'
 */
getStrategiesByScenarioForm.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: getStrategiesByScenario.url(args, options),
 ...
 * @route '/api/strategic-planning/scenarios/{id}/strategies'
 */
getStrategiesByScenarioForm.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
...
const ScenarioStrategyController = {
    getGapsForAssignment,
    assignStrategy,
    getStrategyPortfolio,
    getStrategiesByScenario,
};
