...
* @route '/api/career/{tenantSlug}'
*/
const indexForm = (args: { tenantSlug: string | number } | [tenantSlug: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/career/{tenantSlug}'
*/
indexForm.get = (args: { tenantSlug: string | number } | [tenantSlug: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: index.url(args, options),
    method: 'get',
})
...
* @route '/api/career/{tenantSlug}'
*/
indexForm.head = (args: { tenantSlug: string | number } | [tenantSlug: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/career/{tenantSlug}/jobs/{jobSlug}'
*/
const showForm = (args: { tenantSlug: string | number, jobSlug: string | number } | [tenantSlug: string | number, jobSlug: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/career/{tenantSlug}/jobs/{jobSlug}'
*/
showForm.get = (args: { tenantSlug: string | number, jobSlug: string | number } | [tenantSlug: string | number, jobSlug: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: show.url(args, options),
    method: 'get',
})
...
* @route '/api/career/{tenantSlug}/jobs/{jobSlug}'
*/
showForm.head = (args: { tenantSlug: string | number, jobSlug: string | number } | [tenantSlug: string | number, jobSlug: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/career/{tenantSlug}/jobs/{jobSlug}/apply'
*/
const applyForm = (args: { tenantSlug: string | number, jobSlug: string | number } | [tenantSlug: string | number, jobSlug: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/career/{tenantSlug}/jobs/{jobSlug}/apply'
*/
applyForm.post = (args: { tenantSlug: string | number, jobSlug: string | number } | [tenantSlug: string | number, jobSlug: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: apply.url(args, options),
    method: 'post',
})
