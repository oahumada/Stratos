...
*/
export const verificationConfig = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/deployment/verification-config'
*/
verificationConfig.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: verificationConfig.url(options),
    method: 'get',
})
...
* @route '/deployment/verification-config'
*/
verificationConfig.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: verificationConfig.url(options),
    method: 'head',
})
...
*/
export const verificationMetrics = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/deployment/verification-metrics'
*/
verificationMetrics.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: verificationMetrics.url(options),
    method: 'get',
})
...
* @route '/deployment/verification-metrics'
*/
verificationMetrics.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: verificationMetrics.url(options),
    method: 'head',
})
...
* @route '/deployment/verification-hub'
*/
verificationHub.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: verificationHub.url(options),
    method: 'get',
})
...
* @route '/deployment/verification-hub'
*/
verificationHub.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: verificationHub.url(options),
    method: 'head',
})
...
const deployment = {
    ...
    verificationMetrics: Object.assign(verificationMetrics, verificationMetricsAcc03a),
