...
requestDownload.url = (
    ...
    return (
        requestDownload.definition.url
...
const files = {
    ...
    deleteMultipleFiles: Object.assign(
        deleteMultipleFiles,
        deleteMultipleFiles,
    ),
