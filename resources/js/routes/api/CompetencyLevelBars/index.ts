...
/**
* @see routes/form-schema-complete.php:37
* @route '/api/CompetencyLevelBars'
*/
...
/**
* @see routes/form-schema-complete.php:44
* @route '/api/CompetencyLevelBars'
*/
...
/**
* @see routes/form-schema-complete.php:51
* @route '/api/CompetencyLevelBars/{id}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/api/CompetencyLevelBars/{id}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see routes/form-schema-complete.php:58
* @route '/api/CompetencyLevelBars/{id}'
*/
...
/**
* @see routes/form-schema-complete.php:65
* @route '/api/CompetencyLevelBars/{id}'
*/
...
/**
* @see routes/form-schema-complete.php:72
* @route '/api/CompetencyLevelBars/{id}'
*/
...
/**
* @see routes/form-schema-complete.php:79
* @route '/api/CompetencyLevelBars/search'
*/
...
search.definition = {
    methods: ["post"],
    url: '/api/CompetencyLevelBars/search',
} satisfies RouteDefinition<["post"]>
...
/**
* @see routes/form-schema-complete.php:86
* @route '/api/CompetencyLevelBars/search-with-paciente'
*/
...
searchWithPaciente.definition = {
    methods: ["post"],
    url: '/api/CompetencyLevelBars/search-with-paciente',
} satisfies RouteDefinition<["post"]>
...
export default CompetencyLevelBars