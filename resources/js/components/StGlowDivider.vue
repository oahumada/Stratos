...
<template>
    <div class="relative my-8 h-px w-full overflow-visible">
        ...
        >
            <div
                class="h-1 w-1 rounded-full bg-white shadow-[0_0_15px_#fff,0_0_30px_rgba(99,102,241,1)]"
            ></div>
            <div
                class="absolute h-6 w-6 animate-ping rounded-full border border-indigo-500/30"
            ></div>
        </div>
    </div>
</template>
