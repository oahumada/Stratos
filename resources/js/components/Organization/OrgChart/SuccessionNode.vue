...
import { UserCheck, Briefcase, Star } from 'lucide-vue-next';
...
<template>
    <div 
        ...
        :class="data.type === 'vacancy' ? 'border-amber-500/40' : 'border-indigo-500/40'"
    >
        <Handle type="target" :position="Position.Left" class="handle-flow" />
        
        <div class="node-content">
            <div class="icon-avatar" :class="data.type === 'vacancy' ? 'bg-amber-500/20' : 'bg-indigo-500/20'">
                <Briefcase v-if="data.type === 'vacancy'" class="h-4 w-4 text-amber-400" />
