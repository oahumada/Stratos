    ...
    <div class="space-y-4">
            ...
            <div class="overflow-x-auto">
                <div v-if="heatmap.length > 0" class="flex gap-1 pb-4">
                    ...
                    >
                        <div
                            :style="{
                                backgroundColor: getHeatColor(count, maxHeat),
                            }"
        ...
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            >
                ...
                <p
                    class="mt-1 text-lg font-bold text-blue-600 dark:text-blue-400"
                >
                    {{ peakActivity || 0 }}
                </p>
            </div>
        ...
        >
            <p
                class="mb-2 text-xs font-semibold text-slate-700 dark:text-slate-300"
            >
...
const dailyActivity = ref<number[]>([]);
