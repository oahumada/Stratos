<template>
    <div class="space-y-4">
        ...
        <!-- Export Options -->
        <div
            class="space-y-4 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800"
        >
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="AlertHistory">
                            Historial de Alertas
                        </option>
                        <option value="EscalationPolicy">
        ...
        <div v-if="csvPreview" class="space-y-2">
            ...
            >
                <pre
                    class="break-words whitespace-pre-wrap text-slate-700 dark:text-slate-300"
                    >{{ csvPreview }}</pre
                >
            </div>
        </div>
...
import { PhCopy, PhDownload } from '@phosphor-icons/vue';
import { ref } from 'vue';
