...
const fillWithMockData = () => {
    form.value = {
        ...
        description:
            'Liderar la transformación digital y la creación de nuevos modelos de negocio basados en IA.',
        cube: {
            x_archetype: 'Strategic',
            y_mastery_level: 5,
            z_business_process: 'Nuevos Modelos de Negocio',
            justification:
                'La IA sugiere este posicionamiento debido a la alta incertidumbre y el horizonte temporal de impacto.',
        },
        purpose:
            'Transformar radicalmente la cadena de valor mediante la integración de inteligencia artificial y automatización avanzada.',
        expected_results:
            '1. ROI del 25% en proyectos de IA en el primer año.\n2. Digitalización del 100% de los procesos administrativos.\n3. Reducción del ciclo de innovación de 12 a 3 meses.',
        competencies: [
            {
                name: 'Pensamiento Algorítmico',
                level: 5,
                rationale:
                    'Esencial para entender las capacidades de la IA heredada.',
                bars: [
                    {
                        level: 1,
                        level_name: 'Novato',
                        behavioral_description:
                            'Identifica conceptos básicos de algoritmos.',
                    },
                    {
                        level: 2,
                        level_name: 'Usuario',
                        behavioral_description:
                            'Aplica lógica básica en scripts simples.',
                    },
                    {
                        level: 3,
                        level_name: 'Competente',
                        behavioral_description:
                            'Diseña flujos de datos estructurados.',
                    },
                    {
                        level: 4,
                        level_name: 'Experto',
                        behavioral_description:
                            'Optimiza modelos complejos de decisión.',
                    },
                    {
                        level: 5,
                        level_name: 'Maestro',
                        behavioral_description:
                            'Crea arquitecturas de IA escalables a nivel corporativo.',
                    },
                ],
            },
            {
                ...
                bars: [
                    {
                        level: 1,
                        level_name: 'Novato',
                        behavioral_description: 'Asigna tareas simples.',
                    },
                    {
                        level: 2,
                        level_name: 'Usuario',
                        behavioral_description:
                            'Coordina comunicaciones básicas.',
                    },
                    {
                        level: 3,
                        level_name: 'Competente',
                        behavioral_description:
                            'Gestiona flujos de trabajo mixtos.',
                    },
                    {
                        level: 4,
                        level_name: 'Experto',
                        behavioral_description:
                            'Maximiza el rendimiento del binomio humano-IA.',
                    },
                    {
                        level: 5,
                        level_name: 'Maestro',
                        behavioral_description:
                            'Evoluciona la cultura hacia la simbiosis tecnológica.',
                    },
                ],
            },
        ],
        suggestions:
            'Considerar la creación de una oficina de Ética de Datos supeditada a este rol.',
        bars: {
            behavior:
                'Lidera la integración de inteligencia artificial en todos los niveles operativos, asegurando que el arquetipo Estratégico se materialice en decisiones basadas en datos.',
            attitude:
                'Mentalidad de crecimiento exponencial y ética inquebrantable frente al avance tecnológico.',
            responsibility:
                'Garantizar que la organización no solo adopte IA, sino que evolucione sus capacidades core para un mercado sintético.',
        ...
        blueprint: [
            {
                ...
                levels: [
                    {
                        level: 1,
                        level_name: 'Básico (Ayuda)',
                        description:
                            'Entiende los fundamentos de los algoritmos and ayuda en la recopilación de datos.',
                    },
                    {
                        level: 2,
                        level_name: 'Intermedio (Aplica)',
                        description:
                            'Aplica algoritmos estándar para resolver problemas operativos recurrentes.',
                    },
                    {
                        level: 3,
                        level_name: 'Avanzado (Habilita)',
                        description:
                            'Diseña y habilita flujos algorítmicos que optimizan el trabajo del equipo.',
                    },
                    {
                        level: 4,
                        level_name: 'Experto (Asegura)',
                        description:
                            'Garantiza la robustez and eficiencia de las soluciones algorítmicas organizacionales.',
                    },
                    {
                        level: 5,
                        level_name: 'Maestro (Inspira)',
                        description:
                            'Innova el campo del pensamiento algorítmico, creando nuevos paradigmas de solución.',
                    },
                ],
                skills: [
                    {
                        ...
                        description:
                            'Capacidad para identificar, validar y utilizar modelos estadísticos que anticipen resultados de negocio.',
                        levels: [
                            {
                                level: 1,
                                learning_unit:
                                    'Fundamentos de Estadística y Tipos de Modelos (Regresión, Clasificación).',
                                performance_criterion:
                                    'Identifica correctamente qué modelo aplica para un caso de uso sencillo.',
                            },
                            {
                                level: 2,
                                learning_unit:
                                    'Evaluación de modelos y visualización de precisiones.',
                                performance_criterion:
                                    'Interpreta correctamente una matriz de confusión y el score R2.',
                            },
                            {
                                level: 3,
                                learning_unit:
                                    'Técnicas de feature engineering y limpieza de datos avanzada.',
                                performance_criterion:
                                    'Mejora el rendimiento de un modelo existente mediante el ajuste de variables.',
                            },
                            {
                                level: 4,
                                learning_unit:
                                    'A/B Testing y despliegue de modelos en producción.',
                                performance_criterion:
                                    'Garantiza que el despliegue del modelo no degrade la experiencia del usuario.',
                            },
                            {
                                level: 5,
                                learning_unit:
                                    'Diseño de arquitecturas predictivas propietarias.',
                                performance_criterion:
                                    'Crea un modelo innovador que reduce el costo operativo en un 20%.',
                            },
                        ],
                    },
                    {
                        ...
                        description:
                            'Habilidad para integrar y optimizar Large Language Models (LLMs) en procesos de negocio existentes.',
                        levels: [
                            {
                                level: 1,
                                learning_unit:
                                    'Prompt Engineering Básico y uso de APIs de LLMs.',
                                performance_criterion:
                                    'Genera textos coherentes para tareas simples usando prompts predefinidos.',
                            },
                            {
                                level: 2,
                                learning_unit:
                                    'Optimización de prompts y fine-tuning básico.',
                                performance_criterion:
                                    'Adapta prompts para mejorar la calidad de las respuestas en contextos específicos.',
                            },
                            {
                                level: 3,
                                learning_unit:
                                    'Diseño de arquitecturas de agentes y orquestación de LLMs.',
                                performance_criterion:
                                    'Implementa un flujo de trabajo automatizado que utiliza un LLM para procesar información.',
                            },
                            {
                                level: 4,
                                learning_unit:
                                    'Seguridad, ética y gobernanza en el uso de LLMs.',
                                performance_criterion:
                                    'Evalúa y mitiga riesgos de sesgo y privacidad en aplicaciones con LLMs.',
                            },
                            {
                                level: 5,
                                learning_unit:
                                    'Investigación y desarrollo de nuevos paradigmas con LLMs.',
                                performance_criterion:
                                    'Propone y lidera la implementación de una solución innovadora basada en LLMs que genera una ventaja competitiva.',
                            },
                        ],
                    },
                ],
...
const generateBlueprint = async () => {
    ...
    try {
        const response = await axios.post(
            '/api/strategic-planning/roles/generate-skill-blueprint',
            {
        ...
        simulationNotice.value = response.data.simulation_metadata?.is_simulated
            ? response.data.simulation_metadata.notice
            : null;
        currentStep.value = 5;
    } catch (error) {
...
const steps = computed(() => [
    {
        title: t('role_wizard.step1_title'),
        description: t('role_wizard.step1_desc'),
    },
    {
        title: t('role_wizard.step2_title'),
        description: t('role_wizard.step2_desc'),
    },
    {
        title: t('role_wizard.step3_title'),
        description: t('role_wizard.step3_desc'),
    },
    {
        title: t('role_wizard.step4_title'),
        description: t('role_wizard.step4_desc'),
    },
    {
        title: t('role_wizard.step5_title'),
        description: t('role_wizard.step5_desc'),
    },
]);
...
const formattedJustification = computed(() => {
    ...
    return form.value.cube.justification
        .split('\n')
        .filter((line) => line.trim().length > 0)
        .map((line) => {
            const cleanLine = line.trim();
...
const populateForm = (role: any) => {
    ...
    if (role.ai_archetype_config) {
        form.value.suggestions =
            role.ai_archetype_config.organizational_suggestions || '';
        ...
        if (role.ai_archetype_config.core_competencies) {
            form.value.competencies =
                role.ai_archetype_config.core_competencies;
        }
...
const analyzeRole = async () => {
    ...
    try {
        ...
        form.value.cube.x_archetype = normalizeArchetype(
            data.cube_coordinates.x_archetype,
        );
        form.value.cube.y_mastery_level =
            Number(data.cube_coordinates.y_mastery_level) || 3;
...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-indigo-500/10 ring-1 ring-indigo-500/20"
                >
                    <PhArrowsClockwise
                        :size="40"
                ...
                <h2 class="text-2xl font-black text-white">
                    Cargando Inteligencia Actual...
                </h2>
                <p class="mt-2 text-slate-400">
                    Recuperando coordenadas y configuración del catálogo
                </p>
            </div>
            ...
            >
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div
                        class="flex h-10 w-10 cursor-pointer items-center justify-center rounded-xl border border-indigo-500/30 bg-indigo-500/20 shadow-[0_0_15px_rgba(99,102,241,0.2)] transition-colors hover:bg-indigo-500/40"
                ...
                >
                    <transition name="fade-slide" mode="out-in">
                            ...
                            <div class="space-y-8">
                                <div class="space-y-2">
                                    ...
                                    <input
                                        ...
                                        "
                                        class="w-full rounded-2xl border border-white/20 bg-white/5 px-6 py-5 text-xl font-bold text-white placeholder-white/25 backdrop-blur-md transition-all focus:border-indigo-400 focus:bg-white/8 focus:ring-1 focus:ring-indigo-400/30 focus:outline-none"
                                    />
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        class="w-full resize-none rounded-2xl border border-white/20 bg-white/5 px-6 py-4 text-lg text-white placeholder-white/25 backdrop-blur-md transition-all focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400/30 focus:outline-none"
                                    ></textarea>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            >
                                <div
                                    class="grid grid-cols-1 gap-12 lg:grid-cols-1"
                                >
                                    <!-- Axis X & Axis Y -->
                                    <div class="space-y-10">
                                        ...
                                        <div class="space-y-6">
                                            ...
                                            >
                                                ...
                                                <label
                                                    for="axis-x-control"
                                                    class="text-[10px] font-black tracking-[0.3em] text-white/30 uppercase"
                                                    >{{
                                            ...
                                            >
                                                <button
                                                    ...
                                                    :class="[
                                                        form.cube
                                                            .x_archetype === arc
                                                            ? 'shadow-glow border-indigo-500/50 bg-indigo-500/20 ring-1 ring-indigo-500/40'
                                                ...
                                                >
                                                    ...
                                                    <div class="text-center">
                                                        <div
                                                            class="mb-1 text-[11px] font-black text-white"
                                                        >
                                                            {{
                                                                arc ===
                                                                'Strategic'
                                                        ...
                                                        <div
                                                            class="text-[8px] font-bold tracking-tighter text-white/30 uppercase"
                                                        >
                                                            {{
                                                                arc ===
                                                                'Strategic'
                                        ...
                                        <div class="space-y-6">
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="font-mono text-xl font-black tracking-tighter text-indigo-400"
                                                    >{{
                                                        $t('role_wizard.tier', {
                                                            level: form.cube
                                                                .y_mastery_level,
                                        ...
                                        <StGlowDivider
                                            class="my-12 h-px w-full"
                                        />

                                        <!-- Chuleta / Rationale -->
                                        <div
                                            class="grid grid-cols-1 gap-4 lg:grid-cols-1"
                                        >
                                            <div
                                                class="space-y-3 rounded-2xl border border-indigo-500/10 bg-indigo-500/5 p-6"
                                                style="padding: 12px"
                                            >
                                                <div
                                                    class="flex items-center gap-2"
                                                >
                                                    ...
                                                    />
                                                    <h4
                                                        class="text-[9px] leading-none font-black tracking-[0.2em] text-indigo-400 uppercase"
                                                    >
                                                        {{
                                                            $t(
                                                ...
                                                <div
                                                    class="italic-quote text-[12px] leading-relaxed text-slate-300"
                                                >
                                                    <div
                                                        v-for="(
                                                            line, idx
                                            ...
                                            <div
                                                class="space-y-3 rounded-2xl border border-emerald-500/10 bg-emerald-500/5 p-6"
                                                style="padding: 12px"
                                            >
                                                <div
                                                    class="flex items-center gap-2"
                                                >
                                                    ...
                                                    />
                                                    <h4
                                                        class="text-[9px] leading-none font-black tracking-[0.2em] text-emerald-400 uppercase"
                                                    >
                                                        {{
                                                            $t(
                                                ...
                                                <div
                                                    class="text-[11px] leading-relaxed font-medium text-emerald-100/70"
                                                >
                                                    <div
                                                        v-for="(
                                                            line, idx
                                                        ) in formattedSuggestions"
                                                        :key="idx"
                                                        class="d-flex mb-2 align-top"
                                                    >
                                                        <PhCheckCircle
                        ...
                        >
                            <div class="space-y-4">
                                ...
                                >
                                    Define la razón de ser y los éxitos
                                    tangibles del rol.
                                </p>
                            </div>
                            ...
                            <div class="space-y-8">
                                <StCardGlass
                                    class="pa-10! border-indigo-500/10 bg-indigo-500/5! shadow-[0_0_50px_rgba(99,102,241,0.05)]"
                                    style="padding: 12px; margin: 12px"
                                >
                                    <div class="mb-8 flex items-center gap-6">
                                        <div
                                            class="flex h-14 w-14 items-center justify-center rounded-2xl border border-indigo-500/30 bg-indigo-500/20 text-indigo-400"
                                        >
                                            <PhInfo
                                                :size="28"
                                                weight="duotone"
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        class="w-full resize-none rounded-2xl border border-white/5 bg-white/2 px-8 py-6 text-xl leading-relaxed font-medium text-white placeholder-white/10 transition-all focus:border-indigo-500/50 focus:bg-white/5 focus:outline-none"
                                        placeholder="Define el propósito general de este nodo..."
                                    ></textarea>
                                </StCardGlass>

                                <StCardGlass
                                    class="pa-10! border-emerald-500/10 bg-emerald-500/5! shadow-[0_0_50px_rgba(52,211,153,0.05)]"
                                    style="padding: 12px; margin: 12px"
                                >
                                    <div class="mb-8 flex items-center gap-6">
                                        <div
                                            class="flex h-14 w-14 items-center justify-center rounded-2xl border border-emerald-500/30 bg-emerald-500/20 text-emerald-400"
                                        >
                                            <PhSealCheck
                                                :size="28"
                                                weight="duotone"
                                        ...
                                        <div>
                                            <label
                                                for="role-results-textarea"
                                                class="text-xs font-black tracking-widest text-emerald-400 uppercase"
                                                >Resultados de Valor</label
                                            >
                                            <div
                                                class="text-sm font-medium text-white/30"
                                            >
                                                Qué se espera entregar y lograr
                                                en el tiempo (OKRs, KPIs,
                                                Metas).
                                            </div>
                                        </div>
                                    </div>
                                    <textarea
                                        ...
                                        rows="6"
                                        class="w-full resize-none rounded-2xl border border-white/5 bg-white/2 px-8 py-6 text-base leading-loose font-medium text-emerald-100/70 placeholder-white/10 transition-all focus:border-emerald-500/50 focus:bg-white/5 focus:outline-none"
                                        placeholder="Enumera los resultados tangibles que este rol debe asegurar..."
                                    ></textarea>
                                    <div class="mt-4 flex gap-2">
                                        <div
                                            class="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-[9px] font-black tracking-widest text-emerald-400 uppercase"
                                        >
                                            SMART GOALS
                                        </div>
                                        <div
                        ...
                        >
                            ...
                            >
                                <table class="w-full border-collapse">
                                    <thead>
                                        <tr
                                            class="border-b border-white/10 bg-white/4"
                                        >
                                            <th
                                    ...
                                    <tbody>
                                        ...
                                        >
                                            <tr
                                                class="group cursor-pointer border-b border-white/5 transition-colors duration-300 hover:bg-white/4"
                                            ...
                                            >
                                                <td class="px-8 py-5">
                                                    ...
                                                    >
                                                        ...
                                                        <div
                                                            class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-indigo-500/20 bg-indigo-500/10 text-[10px] font-black text-indigo-400"
                                                        >
                                                            {{ idx + 1 }}
                                                        </div>
                                                        <input
                                                            ...
                                                            v-model="skill.name"
                                                            class="w-full border-none bg-transparent text-sm font-bold text-white transition-colors placeholder:text-white/20 focus:text-indigo-300 focus:outline-none"
                                                            :placeholder="
                                                                $t(
                                                                    'role_wizard.new_capacity',
                                                                )
                                                            "
                                                            @click.stop
                                                        />
                                                ...
                                                <td class="px-4 py-5">
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            class="ml-2 text-xs font-black text-white/30"
                                                            >{{
                                                                skill.level
                                                            }}/5</span
                                                        >
                                                ...
                                                <td class="max-w-xs px-4 py-5">
                                                    ...
                                                    >
                                                        <Tooltip>
                                                            ...
                                                            >
                                                                <p
                                                                    class="line-clamp-2 cursor-help text-[11px] leading-relaxed font-medium text-white/40 italic"
                                                                >
                                                                    {{
                                                                        skill.rationale
                                                                    }}
                                                            ...
                                                            <TooltipContent
                                                                class="max-w-[400px] border-indigo-500/20 bg-slate-900/95 p-4 text-xs leading-relaxed text-indigo-100 shadow-xl backdrop-blur-xl"
                                                            >
                                                                <div
                                                                    class="space-y-2"
                                                                >
                                                ...
                                                >
                                                    <StButtonGlass
                                                        ...
                                                        size="sm"
                                                        :icon="PhTrash"
                                                        class="text-rose-500/30! hover:bg-rose-500/10! hover:text-rose-500!"
                                                        @click.stop="
                                                            removeSkill(idx)
                                                        "
                                                    />
                                            ...
                                            <tr
                                                v-if="
                                                    expandedCompetency === idx
                                                "
                                            >
                                                <td
                                                    colspan="4"
                                                    class="border-b border-indigo-500/10 bg-indigo-500/2 px-8 py-0"
                                                >
                                                    <div class="pt-4 pb-10">
                                                        ...
                                                        >
                                                            ...
                                                            <div
                                                                class="text-[9px] font-medium text-white/20 italic"
                                                            >
                                                                * Selecciona el
                                                                nivel de
                                                                estrellas para
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <Tooltip>
                                                                        ...
                                                                        >
                                                                            <p
                                                                                class="mb-4 line-clamp-3 cursor-help text-[11px] leading-relaxed font-medium"
                                                                                :class="
                                                                                    bar.level ===
                                                                                    skill.level
                                                                                        ? 'text-white/90'
                                                                        ...
                                                                        <TooltipContent
                                                                            class="max-w-[300px] border-white/10 bg-slate-900/95 p-4 text-xs leading-relaxed text-white shadow-xl backdrop-blur-xl"
                                                                        >
                                                                            <div
                                                                                class="space-y-2"
                                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    />
                                                                    <span
                                                                        class="text-[8px] font-black tracking-widest text-indigo-300 uppercase"
                                                                        >Nivel
                                                                        Requerido</span
                                                                    >
                                                                </div>
                                                                ...
                                                                >
                                                                    <span
                                                                        class="text-[8px] font-black tracking-widest text-white/10 uppercase italic"
                                                                        >Descriptor
                                                                        de
                                                                        Nivel</span
                                                                    >
                                                            ...
                                                            <div
                                                                ...
                                                                "
                                                                colspan="5"
                                                                class="col-span-5 rounded-xl border border-dashed border-white/10 bg-white/2 p-6 text-center"
                                                            >
                                                                <p
                                                                    class="text-xs font-medium text-white/30 italic"
                                                                >
                                                                    Esta
                                                                    capacidad
                                                                    fue agregada
                        ...
                        <div
                            ...
                            :key="5"
                            class="mx-auto max-w-6xl space-y-24 px-8 pb-32"
                        >
                            <div class="flex items-end justify-between">
                                <div class="space-y-4">
                                    <h2
                                        class="text-4xl font-black tracking-tight text-white italic"
                                    >
                                    ...
                                    <div
                                        v-if="simulationNotice"
                                        class="mt-4 flex items-center gap-3 rounded-xl border border-amber-500/20 bg-amber-500/10 px-4 py-2"
                                    >
                                        <PhWarningCircle
                                            :size="18"
                                        ...
                                        />
                                        <span
                                            class="text-xs font-bold text-amber-200/70"
                                            >{{ simulationNotice }}</span
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                <div
                                    class="absolute -inset-1 rounded-4xl bg-linear-to-r from-indigo-500/20 to-purple-500/20 opacity-25 blur transition duration-1000 group-hover:opacity-50"
                                ></div>

                                <div
                                    class="relative overflow-hidden rounded-3xl border border-white/10 bg-black/40 p-8 backdrop-blur-xl"
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h3
                                                class="text-xl font-black tracking-tight text-white uppercase italic"
                                            >
                                                {{
                                                    $t('role_wizard.bars_title')
                                                }}
                                            </h3>
                                            <p
                                                class="mt-0.5 text-[10px] font-bold tracking-[0.2em] text-white/30 uppercase"
                                            >
                                                {{
                                                    $t(
                                                        'role_wizard.bars_subtitle',
                                                    )
                                                }}
                                            </p>
                                        </div>
                                    ...
                                    >
                                        <div
                                            class="rounded-3xl border border-white/5 bg-white/5 p-10 transition-colors hover:border-indigo-500/30"
                                            style="padding: 12px"
                                        >
                                            <div
                                        ...
                                        >
                                            ...
                                            <p
                                                class="text-xs leading-relaxed text-white/70 italic"
                                            >
                                                {{ form.bars.attitude }}
                                            </p>
                                        </div>
                                        ...
                                        >
                                            ...
                                            >
                                                {{
                                                    $t(
                                                        'role_wizard.bars_responsibility',
                                                    )
                                                }}
                                            </div>
                                            <p
                            ...
                            <div class="space-y-10">
                                <div class="flex items-center gap-2 px-2">
                                    ...
                                    >
                                        {{
                                            $t('role_wizard.competency_summary')
                                        }}
                                    </h3>
                                </div>
                                ...
                                >
                                    <div
                                        ...
                                        :key="cIdx"
                                        class="rounded-4xl border border-white/5 bg-white/2 p-12 transition-colors hover:bg-white/4"
                                    >
                                        <div
                                            class="mb-4 flex items-center gap-4"
                                        >
                                            <div
                                                class="flex h-10 w-10 items-center justify-center rounded-xl border border-indigo-500/20 bg-indigo-500/10 text-indigo-400"
                                            >
                                                <PhBrain
                                                    :size="20"
                                                    weight="duotone"
                                            ...
                                            <div>
                                                <div
                                                    class="text-sm font-black tracking-tight text-white uppercase italic"
                                                >
                                                    {{ comp.competency_name }}
                                                </div>
                                                <div
                                                    class="text-[9px] font-bold text-white/20 uppercase"
                                                >
                                                    {{
                                                        $t(
                                                            'role_wizard.alignment_ok',
                                                        )
                                                    }}
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            class="mt-4 grid grid-cols-5 gap-1.5 border-t border-white/5 pt-2"
                                        >
                                            <div
                                                v-for="l in comp.levels"
                                                :key="l.level"
                                                class="h-1 rounded-full"
                                                :class="
                                                    l.level ===
                                                    (form.competencies[cIdx]
                                                        ?.level || 3)
                                                        ? 'shadow-glow bg-indigo-500'
                                                        : 'bg-white/5'
                                                "
                                            ></div>
                                        </div>
                                        ...
                                        >
                                            <div
                                                class="text-[9px] font-black text-indigo-400 uppercase"
                                            >
                                                {{
                                                    $t(
                                                        'role_wizard.required_level',
                                                    )
                                                }}:
                                                {{
                                                    form.competencies[cIdx]
                                            ...
                                            <div
                                                class="text-[9px] font-bold text-white/30 uppercase italic"
                                            >
                                                {{
                                                    comp.levels.find(
                                                        (l: { level: any }) =>
