<template>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
            ...
            >
                <p
                    class="text-xs font-medium text-green-600 dark:text-green-300"
                >
                    MILESTONES
                </p>
                <p
                    class="mt-1 text-2xl font-bold text-green-900 dark:text-green-100"
                >
                    {{ totalMilestones }}
                </p>
            </div>
            ...
            >
                <p
                    class="text-xs font-medium text-purple-600 dark:text-purple-300"
                >
                    TASKS
                </p>
                <p
            ...
            >
                <p
                    class="text-xs font-medium text-orange-600 dark:text-orange-300"
                >
                    TOTAL DURATION
                </p>
                <p
                    class="mt-1 text-2xl font-bold text-orange-900 dark:text-orange-100"
                >
                    {{ totalDuration }} days
                </p>
            </div>
        ...
        <div class="space-y-4">
            ...
            >
                ...
                <button
                    ...
                    class="flex w-full items-center justify-between bg-gray-50 px-4 py-3 transition-colors hover:bg-gray-100 dark:bg-gray-800/50 dark:hover:bg-gray-800"
                >
                    <div class="flex flex-1 items-center gap-3">
                        <span
                            :class="[
                                'flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full font-bold text-white',
                ...
                <!-- Phase Content -->
                <div
                    v-if="expandedPhases.includes(phaseIndex)"
                    class="space-y-4 bg-gray-50 px-4 py-4 dark:bg-gray-900/20"
                >
                    <!-- Phase Description -->
                    ...
                    <div class="space-y-3">
                        ...
                        <div
                            ...
                            :key="milestoneIndex"
                            class="border-l-2 border-gray-300 pb-3 pl-6 last:pb-0 dark:border-gray-600"
                        >
                            <div class="flex items-start gap-3">
                                <span class="mt-0.5 font-bold text-green-500"
                                    >✓</span
                                >
                                <div class="flex-1">
                                    <p
                                    ...
                                    <p
                                        v-if="milestone.dueDate"
                                        class="mt-1.5 text-xs text-gray-500 dark:text-gray-500"
                                    >
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        "
                                        class="mt-0.5 h-4 w-4 cursor-pointer rounded border-gray-300 text-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:focus:ring-blue-400"
                                    />
        ...
        <!-- Timeline Chart -->
        <div
            class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/20"
        >
            ...
            <div class="space-y-3">
                ...
                >
                    <div
                        class="w-24 truncate text-sm font-medium text-gray-700 dark:text-gray-300"
                    >
                        {{ phase.name }}
                    </div>
                    <div
                        class="h-2 flex-1 overflow-hidden rounded border border-gray-200 dark:border-gray-600"
                    >
                        <div
                            :style="{
                    ...
                    <div
                        class="w-12 text-right text-xs text-gray-600 dark:text-gray-400"
                    >
                        {{ phase.duration }}d
                    </div>
                </div>
        ...
        <div
            class="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20"
        >
            <h4 class="mb-3 font-semibold text-blue-900 dark:text-blue-100">
                Tips
            </h4>
            <ul class="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                <li class="flex items-start gap-2">
                    ...
                    <span
                        >Click on phases to expand and view milestones and
                        tasks</span
                    >
                </li>
                <li class="flex items-start gap-2">
                    <span class="flex-shrink-0">→</span>
                    <span
                        >Check off tasks as you complete them to track
                        progress</span
                    >
                </li>
                <li class="flex items-start gap-2">
                    <span class="flex-shrink-0">→</span>
                    <span
                        >Timeline bar shows relative duration of each
                        phase</span
                    >
                </li>
            </ul>
...
const phases = computed<Phase[]>(() => {
    ...
    return [
            ...
            milestones: [
                {
                    ...
                    tasks: [
                        {
                            id: '1-1',
                            name: 'Create stakeholder matrix',
                            completed: false,
                        },
                        {
                            id: '1-2',
                ...
                },
                {
                    ...
                    tasks: [
                        {
                            id: '1-4',
                            name: 'Document risk register',
                            completed: false,
                        },
                        {
                            id: '1-5',
                            name: 'Define contingencies',
                            completed: false,
                        },
                    ],
                },
        ...
        },
        {
            ...
            description:
                'Allocate talent, budget, and tools required for execution.',
            duration: 21,
            milestones: [
                {
                    name: 'Team Assembly',
        ...
        },
        {
            ...
            description:
                'Execute core activities and deliverables according to plan.',
            duration: 30,
            milestones: [
                {
                    name: 'Systems Setup',
        ...
        },
        {
            ...
            description:
                'Track performance metrics and optimize based on feedback.',
            duration: 14,
            milestones: [
                {
...
const toggleTask = (
    ...
    const task =
        phases.value[phaseIndex].milestones[milestoneIndex].tasks?.[taskIndex];
    if (task) {
