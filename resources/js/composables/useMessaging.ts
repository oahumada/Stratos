...
export function useMessaging() {
    ...
    async function fetchConversations(page = 1) {
        ...
        try {
            ...
            error.value =
                err.response?.data?.message || 'Error loading conversations';
            throw err;
        } finally {
            loading.value = false;
        }
    ...
    async function fetchConversation(id: string) {
        ...
        try {
            ...
            error.value =
                err.response?.data?.message || 'Error loading conversation';
            throw err;
        } finally {
            loading.value = false;
        }
    ...
    async function createConversation(data: {
        ...
        try {
            ...
            error.value =
                err.response?.data?.message || 'Error creating conversation';
            throw err;
        } finally {
            loading.value = false;
        }
    ...
    async function updateConversation(id: string, data: Partial<Conversation>) {
        ...
        try {
            ...
            error.value =
                err.response?.data?.message || 'Error updating conversation';
            throw err;
        } finally {
            loading.value = false;
        }
    ...
    async function archiveConversation(id: string) {
        ...
        try {
            ...
            error.value =
                err.response?.data?.message || 'Error archiving conversation';
            throw err;
        } finally {
            loading.value = false;
        }
    ...
    async function sendMessage(
        ...
        try {
            ...
            if (currentConversation.value?.id === conversationId) {
                currentConversation.value.last_message_at =
    ...
    async function addParticipant(conversationId: string, peopleId: number) {
        ...
        try {
            ...
            error.value =
                err.response?.data?.message || 'Error adding participant';
            throw err;
        } finally {
            loading.value = false;
        }
    ...
    async function removeParticipant(conversationId: string, peopleId: number) {
        ...
        try {
            await api.delete(
                `/messaging/conversations/${conversationId}/participants/${peopleId}`,
            );

            participants.value = participants.value.filter(
                (p) => p.people_id !== peopleId,
            );
            ...
            error.value =
                err.response?.data?.message || 'Error removing participant';
            throw err;
        } finally {
            loading.value = false;
        }
