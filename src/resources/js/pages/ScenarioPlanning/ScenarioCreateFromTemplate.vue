...
const loadTemplates = async () => {
  loading.value = true
  try {
    const res: any = await api.get('/api/strategic-planning/scenario-templates')
...
const createScenario = async () => {
  ...
  try {
    ...
    const res: any = await api.post(`/api/strategic-planning/scenarios/${selectedTemplate.value.id}/instantiate-from-template`, {
