    ...
    <div class="matching-results">
                    ...
                    <v-menu>
                        ...
                        <v-list>
                            ...
                            <v-list-item @click="viewRecommendations(item)">
                                <v-list-item-title
                                    >View Recommendations</v-list-item-title
                                >
                            </v-list-item>
                            <v-list-item @click="createDevelopmentPlan(item)">
                                <v-list-item-title
                                    >Create Dev Plan</v-list-item-title
                                >
                            </v-list-item>
                            <v-divider></v-divider>
        ...
        <v-dialog v-model="showDetailsDialog" max-width="800px">
            <v-card v-if="selectedMatch">
                <v-card-title>
                    {{ selectedMatch.candidate_name }} →
                    {{ selectedMatch.target_role }}
                </v-card-title>
                <v-divider></v-divider>
                ...
                <v-card-text class="pt-4">
                    ...
                    <v-row class="mb-4">
                        <v-col cols="12" md="4">
                            ...
                            <v-progress-linear
                                ...
                                :color="
                                    getScoreColor(selectedMatch.match_score)
                                "
                                height="8"
                                class="mb-2"
                            ></v-progress-linear>
                    ...
                    <v-list density="compact" class="mb-4">
                        <v-list-item>
                            ...
                            <v-list-item-title
                                >Skill Match: 60%</v-list-item-title
                            >
                        </v-list-item>
                        <v-list-item>
                            <template v-slot:prepend>
                            ...
                            <v-list-item-title
                                >Readiness: 20%</v-list-item-title
                            >
                        </v-list-item>
                        <v-list-item>
                            <template v-slot:prepend>
                            ...
                            <v-list-item-title
                                >Risk Factor: 20%</v-list-item-title
                            >
                        </v-list-item>
                    </v-list>
                    ...
                    <div v-else class="text-success mb-4">
                    ...
                    <v-alert type="info" variant="tonal" class="mb-4">
                        ...
                        {{ formatTransition(selectedMatch.transition_type) }}
                    </v-alert>
                </v-card-text>
