    ...
    <div class="succession-plan-card">
                        ...
                        >
                            ...
                            <v-card-text class="pt-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div
                                        v-else
                                        class="text-error text-body2 mt-2"
                                    >
                                        <v-icon size="small"
                                ...
                                <div
                                    v-if="
                                        plan.secondary_successors &&
                                        plan.secondary_successors.length > 0
                                    "
                                    class="mb-3"
                                >
                                    <div class="text-caption font-weight-bold">
                                ...
                                <div class="mt-4 border-t pt-3">
                                    ...
                                    >
                                        Training
                                        {{ plan.development_plan.duration }}
                                    </v-chip>
                                    <v-chip
        ...
        <v-dialog v-model="showDetailsDialog" max-width="600px">
            <v-card v-if="selectedPlan">
                <v-card-title
                    >{{ selectedPlan.role_name }} - Succession
                    Plan</v-card-title
                >
                <v-divider></v-divider>
                ...
                <v-card-text class="pt-4">
                    ...
                    <v-card variant="outlined" class="pa-3 mb-4">
                        <v-row>
                            <v-col cols="6">
                                ...
                                <div class="text-body2 font-weight-bold">
                                    {{ selectedPlan.planned_retirement }}
                                </div>
                            </v-col>
                            <v-col cols="6">
                                <div class="text-caption text-medium-emphasis">
                                ...
                                <div class="text-body2 font-weight-bold">
                                    {{ selectedPlan.months_to_retirement }}
                                </div>
                            </v-col>
                        </v-row>
                    </v-card>
                    ...
                    <v-card
                        v-if="selectedPlan.primary_successor"
                        variant="outlined"
                        class="pa-3 mb-4"
                    >
                        <div class="font-weight-bold mb-2">
                            {{ selectedPlan.primary_successor.name }}
                        </div>
                        <v-row class="mb-3">
                            <v-col cols="6">
                                <div class="text-caption text-medium-emphasis">
                                ...
                                <v-progress-linear
                                    :value="
                                        selectedPlan.primary_successor.readiness
                                    "
                                    color="primary"
                                    class="mb-2"
                                ></v-progress-linear>
                                <div class="text-body2">
                                    {{
                                        selectedPlan.primary_successor
                                            .readiness
                                    }}%
                                </div>
                            </v-col>
                        ...
                        <div class="text-body2">
                            {{ selectedPlan.development_plan?.description }}
                        </div>
                    </v-card>
                </v-card-text>
...
const successionPlans = computed(() =>
    store.getSuccessionPlans(props.scenarioId),
);
...
const atRiskCount = computed(() => {
    ...
    return plans.filter(
        (p) =>
            !p.primary_successor ||
            (p.primary_successor && (p.months_to_retirement ?? 0) < 6),
    ).length;
});
