<template>
    <div class="skill-gaps-matrix">
        <v-card class="mb-4">
            ...
            <v-card-subtitle>
                Skills vs Departments - Coverage analysis and remediation
                strategies
            </v-card-subtitle>
            ...
            <div class="pa-4 overflow-x-auto">
                <table class="skills-matrix">
                    <thead>
                        <tr>
                            <th>Skill</th>
                            <th v-for="dept in departments" :key="dept">
                                {{ dept }}
                            </th>
                        </tr>
                    </thead>
                            ...
                            >
                                <div class="gap-cell">
                                    <div class="coverage-pct">
                                        {{ getGapCoverage(skill, dept) }}%
                                    </div>
                                    <div class="text-caption">
                                        {{ getRemediationLabel(skill, dept) }}
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                <v-card-text class="pt-4">
                    <v-row class="mb-4">
                        <v-col cols="12" md="6">
                            ...
                            <v-progress-linear
                                ...
                                :color="
                                    getCoverageColor(
                                        selectedGap.coverage_percentage,
                                    )
                                "
                                height="8"
                                class="mb-2"
                    ...
                    <v-list density="compact">
                        <v-list-item>
                            ...
                            <v-list-item-title
                                >Training Program (3 months)</v-list-item-title
                            >
                        </v-list-item>
                        <v-list-item>
                            <template v-slot:prepend>
...
const filteredSkillGaps = computed(() =>
    store.getFilteredSkillGaps(props.scenarioId),
);
