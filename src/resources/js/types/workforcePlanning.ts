export interface WorkforcePlan {
  ...
  scope_type: 'organization_wide' | 'business_unit' | 'department' | 'critical_roles_only';
...
export interface ScopeUnitPayload {
  unit_type: 'department' | 'business_unit' | 'location' | 'cost_center' | 'custom';
  unit_id?: number | null;
  unit_name: string;
  inclusion_reason: 'critical' | 'high_turnover' | 'transformation' | 'growth' | 'downsizing' | 'other';
  notes?: string | null;
}

export interface ScopeRolePayload {
  role_id: number;
  inclusion_reason: 'critical' | 'hard_to_fill' | 'transformation' | 'high_risk' | 'other';
  notes?: string | null;
}
...
export interface StakeholderPayload {
  user_id: number;
  role: 'sponsor' | 'owner' | 'contributor' | 'reviewer' | 'approver' | 'informed';
...
export type ScopeType = 'organization_wide' | 'business_unit' | 'department' | 'critical_roles_only'
...
export interface TransformationProject {
  ...
  workforce_plan_id: number
  project_name: string
  project_type: 'digital_transformation' | 'process_automation' | 'growth' | 'downsizing' | 'merger_acquisition' | 'restructuring' | 'other'
...
export interface TalentRisk {
  id: number
  workforce_plan_id: number
  risk_type: 'aging_workforce' | 'high_turnover' | 'scarce_skills' | 'succession_gap' | 'knowledge_loss' | 'external_competition' | 'other'
  risk_description: string
  affected_unit_id?: number | null
  affected_role_id?: number | null
  severity: 'low' | 'medium' | 'high' | 'critical'
...
export interface PlanDocument {
  id: number
  workforce_plan_id: number
  document_type: 'strategic_plan' | 'business_plan' | 'budget' | 'transformation_plan' | 'other'
