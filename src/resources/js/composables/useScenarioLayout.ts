...
export const LAYOUT_CONFIG = {
    capability: {
        spacing: { hSpacing: 10, vSpacing: 20 },
    ...
    skill: {
        ...
        defaultLayout: 'matrix' as 'auto' | 'radial' | 'matrix' | 'sides',
        matrixVariants: [
            { min: 2, max: 3, rows: 1, cols: 3 },
            { min: 4, max: 8, rows: 2, cols: 4 },
            { min: 9, max: 10, rows: 2, cols: 5 },
        ...
        sides: {
            ...
            vSpacing: 60,
            parentOffset: 80,
            selectedOffsetMultiplier: 0.1,
        },
        linear: { hSpacing: 60, vSpacing: 60 },
        edge: { baseDepth: 35, curveFactor: 0.5, spreadOffset: 10 },
        text: { fontSize: 10, fontWeight: 600 },
    },
    animations: {
