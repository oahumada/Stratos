...
return new class extends Migration {
    ...
    {
        Schema::create('competency_versions', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('obsolescence_reason')->nullable();
            $table->json('metadata')->nullable();
            $table->unsignedBigInteger('created_by')->nullable();
            $table->timestamps();

            $table->foreign('competency_id')->references('id')->on('competencies')->nullOnDelete();
    ...
    {
        Schema::dropIfExists('competency_versions');
    }
};
