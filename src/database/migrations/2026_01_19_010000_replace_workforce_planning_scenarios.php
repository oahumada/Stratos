...
return new class extends Migration {
    public function up(): void
    {
        ...
        // Recreate triggers to keep compatibility with 'scenarios' table
        DB::statement(<<<'SQL'
            CREATE TRIGGER trg_wp_scenarios_insert
            ...
            CREATE TRIGGER trg_wp_scenarios_update
            ...
            CREATE TRIGGER trg_wp_scenarios_delete
