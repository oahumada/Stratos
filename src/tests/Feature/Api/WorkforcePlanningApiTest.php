...
class WorkforcePlanningApiTest extends TestCase
{
    ...
    public function it_can_list_scenarios()
    {
        ...
        $response = $this->getJson('/api/strategic-planning/scenarios');
    ...
    public function it_can_create_a_scenario()
    {
        ...
        $response = $this->postJson('/api/strategic-planning/scenarios', $data);
    ...
    public function it_can_show_a_specific_scenario()
    {
        ...
        $response = $this->getJson("/api/strategic-planning/scenarios/{$scenario->id}");
    ...
    {
        $response = $this->getJson('/api/strategic-planning/scenarios/99999');
    ...
    public function it_can_update_a_scenario()
    {
        ...
        $response = $this->putJson("/api/strategic-planning/scenarios/{$scenario->id}", [
            'name' => 'Updated',
            'status' => 'approved',
        ]);
    ...
    public function it_can_approve_a_scenario()
    {
        ...
        $response = $this->postJson("/api/strategic-planning/scenarios/{$scenario->id}/approve");
    ...
    public function it_can_delete_a_scenario()
    {
        ...
        $response = $this->deleteJson("/api/strategic-planning/scenarios/{$scenario->id}");
    ...
    public function it_can_filter_scenarios_by_status()
    {
        ...
        $response = $this->getJson('/api/strategic-planning/scenarios?status=draft');
