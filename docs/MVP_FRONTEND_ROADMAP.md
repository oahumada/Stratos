...
✅ GET    /gap-analysis/:people_id   (detalle de peoplea)
✅ GET    /gap-analysis/:people_id/vs/:role_id (vs rol específico)
...
- [ ] Asignación a peopleas funciona
