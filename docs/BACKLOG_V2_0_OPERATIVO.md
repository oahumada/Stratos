...
| V2-02 | Notificaciones LMS extendidas (plantillas + canal Slack/In-app)          | Media     | Backend Lead      | 3 Abr, 2026    | Cerrado     | Templates mail+database+broadcast revisadas + Slack webhook para certificado y completado + 3 tests |
...
| V2-04 | SSO LMS con proveedores externos (LinkedIn Learning / SuccessFactors)    | Media     | Integrations Lead | 3 Abr, 2026    | Cerrado     | Diseño OAuth 2.0 PKCE + PoC LinkedIn authenticator (7/9 tests) + validación de estado CSRF |
| V2-05 | Analytics LMS (eventos/KPIs + tasa de certificación por curso)           | Alta      | Data/BI Lead      | 3 Abr, 2026    | Cerrado     | 9 KPIs calculados (completion, certification, at_risk rates) + tablero por curso + learners en riesgo con intervención |
| V2-06 | Integración People Experience en Scenario Planning                       | Media     | Scenario Lead     | 3 Abr, 2026    | Cerrado     | Contrato de datos definido + endpoint integrado + 5 tests E2E (auth, estructura, métricas, headcount, cross-tenant) |
