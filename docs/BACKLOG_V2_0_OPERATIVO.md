...
| ----- | ------------------------------------------------------------------------ | --------- | ----------------- | -------------- | ----------- | ------------------------------------------------------------------------------------------------ |
| V2-01 | Pulido frontend LMS (UX + validaciones cliente + selector de plantillas) | Alta      | Frontend Lead     | 8 Abr, 2026    | En progreso | Flujo completo de edición/guardado validado + feedback visual + accesibilidad básica aplicada    |
