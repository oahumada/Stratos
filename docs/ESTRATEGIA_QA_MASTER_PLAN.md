...
- [ ] **Chaos Engineering:** Pruebas de tolerancia a fallos en microservicios y APIs externas. _(En progreso: tests de resiliencia RAGAS fail-safe + caída de provider Intel + fallback Redis->DB chunking + rate-limit agotado en `ScenarioGenerationIntelTest`.)_
