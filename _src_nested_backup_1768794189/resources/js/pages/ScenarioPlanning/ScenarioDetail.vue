...
import ScenarioActionsPanel from '@/components/StrategicPlanning/ScenarioActionsPanel.vue';
import ScenarioStepperComponent from '@/components/StrategicPlanning/ScenarioStepperComponent.vue';
import StatusTimeline from '@/components/StrategicPlanning/StatusTimeline.vue';
import VersionHistoryModal from '@/components/StrategicPlanning/VersionHistoryModal.vue';
import StrategicPlansOverview from '@/components/StrategicPlanning/WorkforcePlansOverview.vue';
...
<template>
    <div>
        <template v-if="viewMode === 'map'">
            <PrototypeMap v-if="scenario" :scenario="scenario ?? undefined" />
        </template>
        <template v-else>
