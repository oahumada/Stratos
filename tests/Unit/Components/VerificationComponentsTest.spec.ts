...
describe('SchedulerStatus Component', () => {
    ...
    it('renders scheduler status card', () => {
        ...
        expect(wrapper.findAll('[data-testid="status-badge"]').length).toBeGreaterThan(0)
    })
...
describe('NotificationCenter Component', () => {
    ...
    it('filters notifications by type', async () => {
        const notifications = [
            { id: 1, type: 'phase_transition', severity: 'info', message: 'msg1', read: false, created_at: '2026-03-24T10:00:00Z' },
            { id: 2, type: 'config_change', severity: 'warning', message: 'msg2', read: false, created_at: '2026-03-24T10:01:00Z' }
        ]
    ...
    it('filters notifications by severity', async () => {
        const notifications = [
            { id: 1, type: 'phase_transition', severity: 'info', message: 'msg', read: false, created_at: '2026-03-24T10:00:00Z' },
            { id: 2, type: 'config_change', severity: 'error', message: 'msg', read: false, created_at: '2026-03-24T10:01:00Z' }
        ]
    ...
    it('expands notification details', async () => {
        const notifications = [
            { id: 1, type: 'phase_transition', severity: 'info', message: 'msg', read: false, created_at: '2026-03-24T10:00:00Z', metadata: { confidence: 92 } }
        ]
        ...
        expect(wrapper.find('[data-testid="detail-panel-1"]').exists()).toBe(true)
    })
...
describe('ChannelConfig Component', () => {
    ...
    it('shows channel configuration inputs', () => {
        ...
        expect(wrapper.find('[data-testid="slack-webhook-input"]').exists()).toBe(true)
        expect(wrapper.find('[data-testid="email-recipients-input"]').exists()).toBe(true)
    })
    ...
    it('validates webhook URL format', async () => {
        ...
        expect(wrapper.find('[data-testid="webhook-error"]').exists()).toBe(true)
    })
})
...
describe('AuditLogExplorer Component', () => {
    ...
    it('filters logs by action type', async () => {
        const logs = [
            { id: 1, action: 'phase_transition', user_name: 'System', created_at: '2026-03-24T10:00:00Z' },
            { id: 2, action: 'config_change', user_name: 'Admin', created_at: '2026-03-24T10:01:00Z' }
        ]
    ...
    it('filters logs by date range', async () => {
        const logs = [
            { id: 1, action: 'phase_transition', user_name: 'System', created_at: '2026-03-01T10:00:00Z' },
            { id: 2, action: 'config_change', user_name: 'Admin', created_at: '2026-03-24T10:01:00Z' }
        ]
